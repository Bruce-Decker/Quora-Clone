                                                  ...
                                                  >
                                                    ...
                                                    >
                                                      <div className="content">
                                                        ...
                                                        money? Who was the
                                                        person who invented or
                                                        made it? How much was he
                                                        paid?
                                                      </div>
                                                    </div>
                                                  </div>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div className="content_dismiss_body">
                                    The feedback you provide will help us show
                                    you more relevant content in the future.
                                  </div>
                                  <a
                                    className="undo"
                                                              ...
                                                              <div className="ui_qtext_expanded">
                                                                <span className="ui_qtext_rendered_qtext">
                                                                  <div className="ui_qtext_image_outer">
                                                                    <div className="ui_qtext_image_wrapper">
                                                                      <img
                                                                        className="portrait ui_qtext_image zoomable_in_feed"
                                                                        src="https://qph.fs.quoracdn.net/main-qimg-0e5a950db900ba83b393e2cb23806b43"
                                                                        master_src="https://qph.fs.quoracdn.net/main-qimg-0e5a950db900ba83b393e2cb23806b43"
                                                                        master_w={
                                                                          250
                                                                        }
                                                                        master_h={
                                                    ...
                                                    >
                                                      <div id="wR5L77UZ1">
                                                        <div className="u-flex">
                                                              ...
                                                              <div className="ui_layout_photo_text u-flex ui_layout_size--tiny">
                                                                    ...
                                                                    >
                                                                      ...
                                                                      >
                                                                        <span className="ui_avatar u-flex-inline ui_avatar--medium u-flex-none">
                                                                          <img
                                                                            className="ui_avatar_photo ui_avatar--border-circular"
                                                                            src="https://qph.fs.quoracdn.net/main-thumb-782622776-100-izcdaymwbtomzguzorfwyoknxfqoqixc.jpeg"
                                                                            alt="Bruce Decker"
                                                                          />
                                                                        </span>
                                                                      </a>
                                                                ...
                                                                <div className="ui_layout_text u-flex-auto u-width--100 u-flex-align-self--baseline">
                                                                  <div className="u-flex">
                                                                    <div
                                                                      className="editor_wrapper"
                                                                      id="__w2_wR5L77UZ13_editor_outer"
                                                                    >
                                                                      <div
                                                                        className="Comment Editor edit_latex web"
                                                                        id="__w2_wR5L77UZ13_editor"
                                                                      >
                                                                        <div
                                                                          data-group="js-editable"
                                                                          w2cid="wR5L77UZ13"
                                                                          id="__w2_wR5L77UZ13_doc"
                                                                        >
                                                                          <div
                                                                            className="doc empty"
                                                                            contentEditable="true"
                                                                        ...
                                                                        <input
                                                                          ...
                                                                          data-group="js-editable"
                                                                          w2cid="wR5L77UZ13"
                                                                          id="__w2_wR5L77UZ13_file"
                                                                        />
                                                                        <div
                                                                          className="drop_zone hidden"
                                                                          id="__w2_wR5L77UZ13_drop_zone"
                                                                        />
                                                                        <div
                                                                          className="hidden"
                                                                          id="__w2_wR5L77UZ13_link_selector_wrapper"
                                                                        >
                                                                          <div
                                                                            ...
                                                                            id="__w2_wR5L77UZ17_wrapper"
                                                                          >
                                                                            <div className="link_selector_input">
                                                                              <div className="selector_input_interaction">
                                                                                <div
                                                                                  className="CharacterCounter fade_out"
                                                                                  id="__w2_wR5L77UZ18_counter_wrapper"
                                                                                >
                                                                                  <div
                                                                                    className="counter"
                                                                                    id="__w2_wR5L77UZ18_counter"
                                                                                  >
                                                                                    250
                                                                                  </div>
                                                                                </div>
                                                                                <input
                                                                                  ...
                                                                                  placeholder="Search"
                                                                                  w2cid="wR5L77UZ17"
                                                                                  id="__w2_wR5L77UZ17_input"
                                                                                />
                                                                                <div
                                                                                  className="selector_spinner hidden"
                                                                                  id="__w2_wR5L77UZ17_spinner"
                                                                                >
                                                                                  <div className="LoadingDots tiny">
                                                                                    <div className="dot first" />
                                                                                    <div className="dot second" />
                                                                            ...
                                                                            <div
                                                                              className="selector_results_container hidden"
                                                                              id="__w2_wR5L77UZ17_results_container"
                                                                            >
                                                                              <div
                                                                                className="selector_results_container_inner hidden"
                                                                                id="__w2_wR5L77UZ17_results"
                                                                              />
                                                                              <div id="__w2_wR5L77UZ17_empty_input_prompt" />
                                                                            </div>
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                    ...
                                                                    <div
                                                                      className="hidden u-margin-left--sm add_commment_button"
                                                                      id="__w2_wR5L77UZ4_add_root_link"
                                                                    >
                                                                      <a
                                                                        className="ui_button disabled u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--bright_blue ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon"
                                                                        href="#"
                                                                        role="button"
                                                                        id="__w2_wR5L77UZ14_button"
                                                                      >
                                                                        <div
                                                                          className="ui_button_inner"
                                                                          id="__w2_wR5L77UZ14_inner"
                                                                        >
                                                                          <div className="ui_button_label_count_wrapper">
                                                                            <span
                                                                              className="ui_button_label"
                                                                              id="__w2_wR5L77UZ14_label"
                                                                            >
                                                                              Add
                                                                              Comment
                                                                            </span>
                                                          ...
                                                          <div
                                                            className="featured_comments_header u-margin-left--sm u-flex"
                                                            id="__w2_wR5L77UZ2_toggle_links"
                                                          >
                                                            <a
                                                              className="toggle_link toggle_featured is_selected"
                                                              href="#"
                                                              id="__w2_wR5L77UZ2_toggle_featured"
                                                            >
                                                              Recommended
                                                            </a>
                                                            <a
                                                              className="toggle_link toggle_all is_disabled"
                                                              href="#"
                                                              id="__w2_wR5L77UZ2_toggle_all"
                                                            >
                                                              All
                                                            </a>
                                                          </div>
                                                              ...
                                                              >
                                                                ...
                                                                >
                                                                                ...
                                                                                <span id="wR5L77UZ31">
                                                                                  <div className="comment_metadata">
                                                                                    <a
                                                                                      ...
                                                                                      href="/Who-first-invented-the-money-Who-was-the-person-who-invented-or-made-it-How-much-was-he-paid/answer/Brian-Lee-2/comment/93070124"
                                                                                    >
                                                                                      27m
                                                                                      ago
                                                                                    </a>
                                                                        ...
                                                                        <div id="__w2_wR5L77UZ21_footer_wrapper">
                                                                          <div id="wR5L77UZ34">
                                                                            <div id="wR5L77UZ37">
                                                                              ...
                                                                              >
                                                                                <div className="action_bar_inner u-flex">
                                                                                  <div className="ItemComponent CommentReplyItem basic_item u-relative">
                                                                                    <div
                                                                                      className="comment_action_bar"
                                                                                      id="__w2_wR5L77UZ52_action_bar"
                                                                                    >
                                                                                      <div id="__w2_wR5L77UZ52_show_reply_box_link">
                                                                                        <a
                                                                                          className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon"
                                                                                          href="#"
                                                                                          role="button"
                                                                                          id="__w2_wR5L77UZ60_button"
                                                                                        >
                                                                                          <div
                                                                                            className="ui_button_inner"
                                                                                            id="__w2_wR5L77UZ60_inner"
                                                                                          >
                                                                                            <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                                                                              <div id="__w2_wR5L77UZ60_icon">
                                                                                                <span
                                                                                                  className="ui_button_icon"
                                                                                                  aria-hidden="true"
                                                                                                >
                                                                                    ...
                                                                                    <div id="wR5L77UZ53">
                                                                                      <div
                                                                                        className="hidden comment_reply_box"
                                                                                        id="__w2_wR5L77UZ54_reply_box"
                                                                                      >
                                                                                        <div
                                                                                          className="reply_to_comment"
                                                                                          id="__w2_wR5L77UZ54_reply_box_enabled"
                                                                                        >
                                                                                          <div
                                                                                            className="editor_wrapper"
                                                                                            id="__w2_wR5L77UZ96_editor_outer"
                                                                                          >
                                                                                            <div
                                                                                              className="Comment Editor edit_latex web"
                                                                                              id="__w2_wR5L77UZ96_editor"
                                                                                            >
                                                                                              <div
                                                                                                data-group="js-editable"
                                                                                                w2cid="wR5L77UZ96"
                                                                                                id="__w2_wR5L77UZ96_doc"
                                                                                              >
                                                                                                <div
                                                                                                  className="doc empty"
                                                                                                  contentEditable="true"
                                                                                              ...
                                                                                              <input
                                                                                                ...
                                                                                                data-group="js-editable"
                                                                                                w2cid="wR5L77UZ96"
                                                                                                id="__w2_wR5L77UZ96_file"
                                                                                              />
                                                                                              <div
                                                                                                className="drop_zone hidden"
                                                                                                id="__w2_wR5L77UZ96_drop_zone"
                                                                                              />
                                                                                              <div
                                                                                                className="hidden"
                                                                                                id="__w2_wR5L77UZ96_link_selector_wrapper"
                                                                                              >
                                                                                                <div
                                                                                                  className="Selector LinkSelector"
                                                                                                  tabIndex={
                                                                                                  ...
                                                                                                  id="__w2_wR5L77UZ98_wrapper"
                                                                                                >
                                                                                                  <div className="link_selector_input">
                                                                                                    <div className="selector_input_interaction">
                                                                                                      <div
                                                                                                        className="CharacterCounter fade_out"
                                                                                                        id="__w2_wR5L77UZ99_counter_wrapper"
                                                                                                      >
                                                                                                        <div
                                                                                                          className="counter"
                                                                                                          id="__w2_wR5L77UZ99_counter"
                                                                                                        >
                                                                                                          250
                                                                                                        </div>
                                                                                                      </div>
                                                                                                      <input
                                                                                                        ...
                                                                                                        placeholder="Search"
                                                                                                        w2cid="wR5L77UZ98"
                                                                                                        id="__w2_wR5L77UZ98_input"
                                                                                                      />
                                                                                                      <div
                                                                                                        className="selector_spinner hidden"
                                                                                                        id="__w2_wR5L77UZ98_spinner"
                                                                                                      >
                                                                                                        <div className="LoadingDots tiny">
                                                                                                          <div className="dot first" />
                                                                                                          <div className="dot second" />
                                                                                                  ...
                                                                                                  <div
                                                                                                    className="selector_results_container hidden"
                                                                                                    id="__w2_wR5L77UZ98_results_container"
                                                                                                  >
                                                                                                    <div
                                                                                                      className="selector_results_container_inner hidden"
                                                                                                      id="__w2_wR5L77UZ98_results"
                                                                                                    />
                                                                                                    <div id="__w2_wR5L77UZ98_empty_input_prompt" />
                                                                                                  </div>
                                                                                                </div>
                                                                                              </div>
                                                                                            </div>
                                                                                          </div>
                                                                                          <div className="reply_submit_button_wrapper">
                                                                                            <div id="__w2_wR5L77UZ54_add_comment_link">
                                                                                              <a
                                                                                                className="ui_button disabled u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--bright_blue ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon"
                                                                                                href="#"
                                                                                                role="button"
                                                                                                id="__w2_wR5L77UZ97_button"
                                                                                              >
                                                                                                <div
                                                                                                  className="ui_button_inner"
                                                                                                  id="__w2_wR5L77UZ97_inner"
                                                                                                >
                                                                                                  <div className="ui_button_label_count_wrapper">
                                                                                                    <span
                                                                                                      className="ui_button_label"
                                                                                                      id="__w2_wR5L77UZ97_label"
                                                                                                    >
                                                                                                      Reply
                                                                                                    </span>
                                                                                                  </div>
                                                                                  ...
                                                                                  <div className="overflow action_item overflow_link u-relative u-pointer-events--auto">
                                                                                    <div
                                                                                      className="overflow_link"
                                                                                      id="__w2_wR5L77UZ38_overflow_link"
                                                                                    >
                                                                                      <a
                                                                                        ...
                                                                                        role="button"
                                                                                        aria-label="More options"
                                                                                        id="__w2_wR5L77UZ51_button"
                                                                                      >
                                                                                        <div
                                                                                          className="ui_button_inner"
                                                                                          id="__w2_wR5L77UZ51_inner"
                                                                                        >
                                                                                          <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                                                                            <div id="__w2_wR5L77UZ51_icon">
                                                                                              <span
                                                                                                className="ui_button_icon"
                                                                                                aria-hidden="true"
                                                                                              >
                                                                                  ...
                                                                                  <div
                                                                                    className="hover_menu hidden show_nub right_align fixed_menu_width no_body_attach"
                                                                                    id="__w2_wR5L77UZ38_overflow_menu"
                                                                                  >
                                                                                    <div
                                                                                      className="hover_menu_contents lazy"
                                                                                      id="__w2_wR5L77UZ38_overflow_menu_contents"
                                                                                    />
                                                                                  </div>
                                                                                </div>
                                                                              </div>
                                                                  ...
                                                                  <div
                                                                    ...
                                                                    id="__w2_wR5L77UZ24_comment_list_wrapper"
                                                                  >
                                                                    <div className="thread_border" />
                                                                    <div
                                                                      className="comment_list"
                                                                      id="__w2_wR5L77UZ24_comment_list"
                                                                    >
                                                                      <div
                                                                        className="comment_wrapper last comment_to_append"
                                                                        id="__w2_wR5L77UZ56_comment"
                                                                      >
                                                                        <div id="wR5L77UZ61">
                                                                          <div
                                                                            className="comment threaded_comment"
                                                                            id="__w2_wR5L77UZ62_comment_inner"
                                                                          >
                                                                            <div className="comment_contents">
                                                                              <div>
                                                                                <div className="ui_layout_photo_text u-flex ui_layout_size--tiny">
                                                                                  ...
                                                                                  <div className="ui_layout_text u-flex-auto u-width--100 u-flex-align-self--center">
                                                                                    <span className="author_name">
                                                                                      <span id="wR5L77UZ69">
                                                                                        <span id="__w2_wR5L77UZ70_link">
                                                                                          <a
                                                                                            className="user"
                                                                                            href="/profile/Bruce-Decker-12"
                                                                                            action_mousedown="UserLinkClickthrough"
                                                                                            id="__w2_wR5L77UZ70_name_link"
                                                                                          >
                                                                                            Bruce
                                                                                            Decker
                                                                                          </a>
                                                                                    ...
                                                                                    <span className="comment_metadata">
                                                                                      <span id="wR5L77UZ71">
                                                                                        <div className="comment_metadata">
                                                                                          <a
                                                                                            className="comment_timestamp"
                                                                                            href="/Who-first-invented-the-money-Who-was-the-person-who-invented-or-made-it-How-much-was-he-paid/answer/Brian-Lee-2/comment/93070184"
                                                                                          >
                                                                                            26m
                                                                                            ago
                                                                                          </a>
                                                                              ...
                                                                              <div
                                                                                className="full_comment_text"
                                                                                id="__w2_wR5L77UZ62_full_comment_text"
                                                                              >
                                                                                <div
                                                                                  className="TCommentTruncatedInlineEditor InlineEditor TCommentFullTextInlineEditor inline_editor_content"
                                                                                  id="__w2_wR5L77UZ73_inline_editor_content"
                                                                                >
                                                                                  <span className="inline_editor_value">
                                                                                    <div id="__w2_wR5L77UZ76_expanded">
                                                                                      <div className="ui_qtext_expanded">
                                                                                        <span className="ui_qtext_rendered_qtext">
                                                                                          <p className="ui_qtext_para u-ltr u-text-align--start">
                                                                                            N/A
                                                                                ...
                                                                                <div
                                                                                  className="rteditor inline_editor_content threaded_inline_editor hidden"
                                                                                  id="__w2_wR5L77UZ73_inline_editor_form"
                                                                                >
                                                                                  <div className="inline_editor_form">
                                                                                    <div
                                                                                      className="editor_wrapper"
                                                                                      id="__w2_wR5L77UZ80_editor_outer"
                                                                                    >
                                                                                      <div
                                                                                        className="Comment Editor edit_latex web"
                                                                                        id="__w2_wR5L77UZ80_editor"
                                                                                      >
                                                                                        <div
                                                                                          data-group="js-editable"
                                                                                          w2cid="wR5L77UZ80"
                                                                                          id="__w2_wR5L77UZ80_doc"
                                                                                        >
                                                                                          <div
                                                                                            className="doc"
                                                                                            contentEditable="true"
                                                                                        ...
                                                                                        <input
                                                                                          ...
                                                                                          data-group="js-editable"
                                                                                          w2cid="wR5L77UZ80"
                                                                                          id="__w2_wR5L77UZ80_file"
                                                                                        />
                                                                                        <div
                                                                                          className="drop_zone hidden"
                                                                                          id="__w2_wR5L77UZ80_drop_zone"
                                                                                        />
                                                                                        <div
                                                                                          className="hidden"
                                                                                          id="__w2_wR5L77UZ80_link_selector_wrapper"
                                                                                        >
                                                                                          <div
                                                                                            className="Selector LinkSelector"
                                                                                            tabIndex={
                                                                                            ...
                                                                                            id="__w2_wR5L77UZ85_wrapper"
                                                                                          >
                                                                                            <div className="link_selector_input">
                                                                                              <div className="selector_input_interaction">
                                                                                                <div
                                                                                                  className="CharacterCounter fade_out"
                                                                                                  id="__w2_wR5L77UZ86_counter_wrapper"
                                                                                                >
                                                                                                  <div
                                                                                                    className="counter"
                                                                                                    id="__w2_wR5L77UZ86_counter"
                                                                                                  >
                                                                                                    250
                                                                                                  </div>
                                                                                                </div>
                                                                                                <input
                                                                                                  ...
                                                                                                  placeholder="Search"
                                                                                                  w2cid="wR5L77UZ85"
                                                                                                  id="__w2_wR5L77UZ85_input"
                                                                                                />
                                                                                                <div
                                                                                                  className="selector_spinner hidden"
                                                                                                  id="__w2_wR5L77UZ85_spinner"
                                                                                                >
                                                                                                  <div className="LoadingDots tiny">
                                                                                                    <div className="dot first" />
                                                                                                    <div className="dot second" />
                                                                                            ...
                                                                                            <div
                                                                                              className="selector_results_container hidden"
                                                                                              id="__w2_wR5L77UZ85_results_container"
                                                                                            >
                                                                                              <div
                                                                                                className="selector_results_container_inner hidden"
                                                                                                id="__w2_wR5L77UZ85_results"
                                                                                              />
                                                                                              <div id="__w2_wR5L77UZ85_empty_input_prompt" />
                                                                                            </div>
                                                                                          </div>
                                                                                        </div>
                                                                                      </div>
                                                                                    ...
                                                                                    <div
                                                                                      className="u-flex u-margin-top--sm"
                                                                                      id="__w2_wR5L77UZ73_inline_editor_buttons"
                                                                                    >
                                                                                      <div
                                                                                        className="u-flex u-margin-left--auto u-flex-align--center u-padding-right--md"
                                                                                        id="__w2_wR5L77UZ73_inline_editor_cancel"
                                                                                      >
                                                                                        <a
                                                                                          className="ui_button u-nowrap ui_button--styled ui_button--SimpleLinkStyle ui_button--SimpleLinkStyle--gray ui_button--size_small u-inline-block"
                                                                                          href="#"
                                                                                          role="button"
                                                                                          id="__w2_wR5L77UZ81_button"
                                                                                        >
                                                                                          <div
                                                                                            className="ui_button_inner"
                                                                                            id="__w2_wR5L77UZ81_inner"
                                                                                          >
                                                                                            <div className="ui_button_label_count_wrapper">
                                                                                              <span
                                                                                                className="ui_button_label"
                                                                                                id="__w2_wR5L77UZ81_label"
                                                                                              >
                                                                                                Cancel
                                                                                              </span>
                                                                                            </div>
                                                                                      ...
                                                                                      <div
                                                                                        className="u-flex"
                                                                                        id="__w2_wR5L77UZ73_inline_editor_submit"
                                                                                      >
                                                                                        <a
                                                                                          className="ui_button u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--bright_blue ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon"
                                                                                          href="#"
                                                                                          role="button"
                                                                                          id="__w2_wR5L77UZ82_button"
                                                                                        >
                                                                                          <div
                                                                                            className="ui_button_inner"
                                                                                            id="__w2_wR5L77UZ82_inner"
                                                                                          >
                                                                                            <div className="ui_button_label_count_wrapper">
                                                                                              <span
                                                                                                className="ui_button_label"
                                                                                                id="__w2_wR5L77UZ82_label"
                                                                                              >
                                                                                                Update
                                                                                              </span>
                                                                                            </div>
                                                                              ...
                                                                              <div id="__w2_wR5L77UZ62_footer_wrapper">
                                                                                <div id="wR5L77UZ74">
                                                                                  <div id="wR5L77UZ77">
                                                                                    <div
                                                                                      className="icon_action_bar"
                                                                                      id="__w2_wR5L77UZ78_action_bar"
                                                                                    >
                                                                                      <div className="action_bar_inner u-flex">
                                                                                        <div className="ItemComponent CommentReplyItem basic_item u-relative">
                                                                                          <div
                                                                                            className="comment_action_bar"
                                                                                            id="__w2_wR5L77UZ92_action_bar"
                                                                                          >
                                                                                            <div id="__w2_wR5L77UZ92_show_reply_box_link">
                                                                                              <a
                                                                                                className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon"
                                                                                                href="#"
                                                                                                role="button"
                                                                                                id="__w2_wR5L77UZ101_button"
                                                                                              >
                                                                                                <div
                                                                                                  className="ui_button_inner"
                                                                                                  id="__w2_wR5L77UZ101_inner"
                                                                                                >
                                                                                                  <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                                                                                    <div id="__w2_wR5L77UZ101_icon">
                                                                                                      <span
                                                                                                        className="ui_button_icon"
                                                                                                        aria-hidden="true"
                                                                                                      >
                                                                                          ...
                                                                                          <div id="wR5L77UZ93">
                                                                                            <div
                                                                                              className="hidden comment_reply_box"
                                                                                              id="__w2_wR5L77UZ94_reply_box"
                                                                                            >
                                                                                              <div
                                                                                                className="reply_to_comment"
                                                                                                id="__w2_wR5L77UZ94_reply_box_enabled"
                                                                                              >
                                                                                                <div
                                                                                                  className="editor_wrapper"
                                                                                                  id="__w2_wR5L77UZ102_editor_outer"
                                                                                                >
                                                                                                  <div
                                                                                                    className="Comment Editor edit_latex web"
                                                                                                    id="__w2_wR5L77UZ102_editor"
                                                                                                  >
                                                                                                    <div
                                                                                                      data-group="js-editable"
                                                                                                      w2cid="wR5L77UZ102"
                                                                                                      id="__w2_wR5L77UZ102_doc"
                                                                                                    >
                                                                                                      <div
                                                                                                        className="doc empty"
                                                                                                        contentEditable="true"
                                                                                                    ...
                                                                                                    <input
                                                                                                      ...
                                                                                                      data-group="js-editable"
                                                                                                      w2cid="wR5L77UZ102"
                                                                                                      id="__w2_wR5L77UZ102_file"
                                                                                                    />
                                                                                                    <div
                                                                                                      className="drop_zone hidden"
                                                                                                      id="__w2_wR5L77UZ102_drop_zone"
                                                                                                    />
                                                                                                    <div
                                                                                                      className="hidden"
                                                                                                      id="__w2_wR5L77UZ102_link_selector_wrapper"
                                                                                                    >
                                                                                                      <div
                                                                                                        className="Selector LinkSelector"
                                                                                                        tabIndex={
                                                                                                        ...
                                                                                                        id="__w2_wR5L77UZ104_wrapper"
                                                                                                      >
                                                                                                        <div className="link_selector_input">
                                                                                                          <div className="selector_input_interaction">
                                                                                                            <div
                                                                                                              className="CharacterCounter fade_out"
                                                                                                              id="__w2_wR5L77UZ105_counter_wrapper"
                                                                                                            >
                                                                                                              <div
                                                                                                                className="counter"
                                                                                                                id="__w2_wR5L77UZ105_counter"
                                                                                                              >
                                                                                                                250
                                                                                                              </div>
                                                                                                            </div>
                                                                                                            <input
                                                                                                              ...
                                                                                                              placeholder="Search"
                                                                                                              w2cid="wR5L77UZ104"
                                                                                                              id="__w2_wR5L77UZ104_input"
                                                                                                            />
                                                                                                            <div
                                                                                                              className="selector_spinner hidden"
                                                                                                              id="__w2_wR5L77UZ104_spinner"
                                                                                                            >
                                                                                                              <div className="LoadingDots tiny">
                                                                                                                <div className="dot first" />
                                                                                                                <div className="dot second" />
                                                                                                        ...
                                                                                                        <div
                                                                                                          className="selector_results_container hidden"
                                                                                                          id="__w2_wR5L77UZ104_results_container"
                                                                                                        >
                                                                                                          <div
                                                                                                            className="selector_results_container_inner hidden"
                                                                                                            id="__w2_wR5L77UZ104_results"
                                                                                                          />
                                                                                                          <div id="__w2_wR5L77UZ104_empty_input_prompt" />
                                                                                                        </div>
                                                                                                      </div>
                                                                                                    </div>
                                                                                                  </div>
                                                                                                ...
                                                                                                <div className="reply_submit_button_wrapper">
                                                                                                  <div id="__w2_wR5L77UZ94_add_comment_link">
                                                                                                    <a
                                                                                                      className="ui_button disabled u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--bright_blue ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon"
                                                                                                      href="#"
                                                                                                      role="button"
                                                                                                      id="__w2_wR5L77UZ103_button"
                                                                                                    >
                                                                                                      <div
                                                                                                        className="ui_button_inner"
                                                                                                        id="__w2_wR5L77UZ103_inner"
                                                                                                      >
                                                                                                        <div className="ui_button_label_count_wrapper">
                                                                                                          <span
                                                                                                            className="ui_button_label"
                                                                                                            id="__w2_wR5L77UZ103_label"
                                                                                                          >
                                                                                                            Reply
                                                                                                          </span>
                                                                                                        </div>
                                                                                        ...
                                                                                        <div className="overflow action_item overflow_link u-relative u-pointer-events--auto">
                                                                                          <div
                                                                                            className="overflow_link"
                                                                                            id="__w2_wR5L77UZ78_overflow_link"
                                                                                          >
                                                                                            <a
                                                                                              className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only"
                                                                                              href="#"
                                                                                              role="button"
                                                                                              aria-label="More options"
                                                                                              id="__w2_wR5L77UZ91_button"
                                                                                            >
                                                                                              <div
                                                                                                className="ui_button_inner"
                                                                                                id="__w2_wR5L77UZ91_inner"
                                                                                              >
                                                                                                <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                                                                                  <div id="__w2_wR5L77UZ91_icon">
                                                                                                    <span
                                                                                                      className="ui_button_icon"
                                                                                                      aria-hidden="true"
                                                                                                    >
                                                                                        ...
                                                                                        <div
                                                                                          className="hover_menu hidden show_nub right_align fixed_menu_width no_body_attach"
                                                                                          id="__w2_wR5L77UZ78_overflow_menu"
                                                                                        >
                                                                                          <div
                                                                                            className="hover_menu_contents lazy"
                                                                                            id="__w2_wR5L77UZ78_overflow_menu_contents"
                                                                                          />
                                                                                        </div>
                                                                                      </div>
                                                                                    </div>
                                                                        ...
                                                                        <div
                                                                          className="comment_list"
                                                                          id="__w2_wR5L77UZ63_container"
                                                                        >
                                                                          <div id="__w2_wR5L77UZ63_new_comment" />
                                                                          <div id="__w2_wR5L77UZ63_added_comments" />
                                                                        </div>
                                                                        <div
                                                                          className="hidden u-relative"
                                                                          id="__w2_wR5L77UZ65_comment_list_wrapper"
                                                                        >
                                                                          <div className="thread_border" />
                                                                          <div
                                                                            className="comment_list"
                                                                            id="__w2_wR5L77UZ65_comment_list"
                                                                          >
                                                                            <div id="__w2_wR5L77UZ65_comment_list_placeholder" />
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                      <div id="__w2_wR5L77UZ24_comment_list_first_level_placeholder_2" />
                                                                    </div>
                                                                  </div>
                                                                  <div
                                                                    className="show_child_link_wrapper u-relative"
                                                                    id="__w2_wR5L77UZ25_show_child_link_wrapper"
                                                                  >
                                                                    <div className="thread_border" />
                                                                    <a
                                                                      className="show_child_link comment_list"
                                                                      href="#"
                                                                      id="__w2_wR5L77UZ25_show_child_link"
                                                                    >
                                                                      <strong>
                                                                        <span id="wR5L77UZ58">
                                                                          <span id="__w2_wR5L77UZ59_link">
                                                                            <span className="user">
                                                                              Bruce
                                                                              Decker
                                                                            </span>
                                      ...
                                      <div className="bdwxubvhzryrxtvfzcdn xfpnurkcyvpsdmxpkucg nqhjqevihbtsnvakbejl">
                                        ...
                                        >
                                          ...
                                          <div className="content_dismiss_body">
                                            ...
                                            us show you more relevant content in
                                            the future.
                                          </div>
                                          <a
                                            className="undo"
