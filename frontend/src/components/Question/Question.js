...
class Question extends Component {
 ...
 <div>
             ...
             <div className="NewGridQuestionPage QuestionMain cardified" id="__w2_w6AYVNK72_grid">
             ...
             <div id="w2cECm6L1" />
             <div id="w2cECm6L3">
             <div className="TopicList QuestionTopicHorizontalList" id="__w2_w2cECm6L4_topics_list">
                <div id="w2cECm6L12">
                   <div className="TopicListItems2 QuestionTopicHorizontalListItems Toggle QuestionTopicListItems SimpleToggle" id="__w2_w2cECm6L13__truncated">
                      {this.state.topics.map(topic => 
                      <span id="w0Ia0Toj3">
                         <div className="TopicListItem QuestionTopicListItem topic_pill" id="__w2_w0Ia0Toj4_topic_list_item">
                            <div className="u-inline-block u-nowrap">
                               <div id="w0Ia0Toj9">
                                  <div className="hover_menu hidden white_bg show_nub" id="__w2_w0Ia0Toj10_menu">
                                     <div className="hover_menu_contents" id="__w2_w0Ia0Toj10_menu_contents"> </div>
                                  </div>
                                  <a className="TopicNameLink HoverMenu topic_name" href="/topic/History-of-Inventions" action_mousedown="TopicLinkClickthrough" id="__w2_w0Ia0Toj10_link"><span className="name_text"><span id="w0Ia0Toj16"><span className="TopicName TopicNameSpan" id="__w2_w0Ia0Toj17_card">{topic}</span></span></span></a>
                               </div>
                            </div>
                         </div>
                      </span>
                      ...
                      <span id="w0Ia0Toj1">
                         <div className="QuestionTopicEditButton edit_topics_link u-inline" alt="Edit Topics" id="__w2_w0Ia0Toj2_edit_link" />
                      </span>
                      </div>
                   </div>
                </div>
             ...
             <div className="InlineEditor QuestionTextInlineEditor inline_editor_content" id="__w2_w2cECm6L14_inline_editor_content">
                <span className="inline_editor_value">
                   <h1><span className="rendered_qtext">{this.state.question}</span></h1>
                </span>
             </div>
             <div className="rteditor inline_editor_content hidden" id="__w2_w2cECm6L14_inline_editor_form">
             <div className="inline_editor_form">
             <div className="editor_wrapper" id="__w2_w2cECm6L16_editor_outer">
                <div className="Title QuestionTitle Editor edit_latex web" id="__w2_w2cECm6L16_editor">
                   <div data-group="js-editable" w2cid="w2cECm6L16" id="__w2_w2cECm6L16_doc">
                      <div className="doc" contentEditable="true" data-kind="doc" placeholder>
                         <div className="section" data-type="plain" data-dir="LTR" data-indent={0} data-kind="section">
                            <div className="span" data-kind="span">
                               <div className="content">Who first invented the money? Who was the person who invented or made it? How much was he paid?</div>
                            </div>
                         </div>
                      </div>
                   </div>
                   <div className="CharacterCounter fade_out" id="__w2_w2cECm6L17_counter_wrapper">
                      <div className="counter" id="__w2_w2cECm6L17_counter">155</div>
                   </div>
                   <div className="hidden" id="__w2_w2cECm6L16_link_selector_wrapper">
                      <div className="LinkSelector Selector" tabIndex={-1} id="__w2_w2cECm6L18_wrapper">
                         <div className="link_selector_input">
                            <div className="selector_input_interaction">
                               <div className="CharacterCounter fade_out" id="__w2_w2cECm6L19_counter_wrapper">
                                  <div className="counter" id="__w2_w2cECm6L19_counter">250</div>
                               </div>
                               <input className="selector_input text" type="text" defaultValue data-group="js-editable" placeholder="Search" w2cid="w2cECm6L18" id="__w2_w2cECm6L18_input" />
                               <div className="selector_spinner hidden" id="__w2_w2cECm6L18_spinner">
                                  ...
                                  <div className="selector_results_container hidden" id="__w2_w2cECm6L18_results_container">
                                     <div className="selector_results_container_inner hidden" id="__w2_w2cECm6L18_results" />
                                        <div id="__w2_w2cECm6L18_empty_input_prompt" /></div>
                                     </div>
                                  </div>
                               </div>
                            </div>
                            <div className="form_buttons" id="__w2_w2cECm6L14_inline_editor_buttons">
                               <div className="inline_editor_buttons"><a className="inline_editor_button inline_editor_cancel_button" href="#" id="__w2_w2cECm6L14_inline_editor_cancel">Cancel</a><a className="submit_button" href="#" action_mousedown="InlineEditorAnswerAdd" id="__w2_w2cECm6L14_inline_editor_submit">Update</a></div>
                            </div>
                         </div>
                      </div>
                   </div>
             ...
             <div id="w2cECm6L7" />
             <div className="form_buttons hidden shared_form" id="__w2_w6AYVNK726_form_button_container"><a className="submit_button" id="__w2_w6AYVNK726_question_update">Update</a><a className="cancel_button" id="__w2_w6AYVNK726_question_cancel">Cancel</a></div>
             <div id="w2cECm6L9">
             <div className="icon_action_bar" id="__w2_w2cECm6L10_action_bar">
                <div className="action_bar_inner u-flex">
                   <div className="ItemComponent WriteAnswerPrimaryActionItem primary_item u-relative">
                      <span id="wEimc2ML14">
                         <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--blue ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon" href="#" role="button" action_target="{&quot;qid&quot;: 31450631, &quot;type&quot;: &quot;question&quot;}" id="__w2_wEimc2ML40_button">
                            <div className="ui_button_inner" id="__w2_wEimc2ML40_inner">
                               ...
                               <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wEimc2ML40_label">Answer</span></div>
                            </div>
                         </a>
                      </span>
                   </div>
                         ...
                         <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon" href="#" role="button" action_click="QuestionFollow" action_target="{&quot;qid&quot;: 31450631, &quot;type&quot;: &quot;question&quot;}" id="__w2_wEimc2ML37_button">
                            <div className="ui_button_inner" id="__w2_wEimc2ML37_inner">
                               ...
                               <div className="ui_button_label_count_wrapper">
                                  <span className="ui_button_label" id="__w2_wEimc2ML37_label">Follow</span>
                                  <span className="ui_button_count" aria-hidden="true" id="__w2_wEimc2ML37_count_wrapper">
                                  <span className="bullet"> · </span><span className="ui_button_count_inner" id="__w2_wEimc2ML37_count">{this.state.follower_count}</span></span>
                               </div>
                            </div>
                         </a>
                      </span>
                   ...
                   <div className="ItemComponent RequestPrimaryActionItem primary_item u-relative">
                      <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon" href="#" role="button" id="__w2_wEimc2ML20_button">
                         <div className="ui_button_inner" id="__w2_wEimc2ML20_inner">
                            <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                               <div id="__w2_wEimc2ML20_icon">
                                  <span className="ui_button_icon" aria-hidden="true">
                                     <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                        <g id="request" className="icon_svg-stroke" stroke="#666" strokeWidth="1.5" fill="none" fillRule="evenodd">
                                           <g transform="translate(10.000000, 5.000000)" className="icon_svg-fill" fill="none">
                                           ...
                                           <path d="M6,10 L8.5,13 L6,16 M3,13.0244257 L8.49508293,13.0244257" strokeLinecap="round" strokeLinejoin="round" />
                                        </g>
                                     </svg>
                                  </span>
                               </div>
                            </div>
                            <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wEimc2ML20_label">Request</span></div>
                         </div>
                      </a>
                      <div className="u-relative">
                         <div className="RequestActionCaret hidden" id="__w2_wEimc2ML19_caret" /></div>
                      </div>
                      <div className="CommentsActionItem ItemComponent ActionItemComponent action_item secondary_item u-relative" id="__w2_wEimc2ML4_link">
                         <div id="wEimc2ML21">
                            <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="Comments" id="__w2_wEimc2ML39_button">
                               <div className="ui_button_inner" id="__w2_wEimc2ML39_inner">
                                  <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                      ...
                      <div className="ItemComponent ActionItemComponent DownvoteActionItem action_item secondary_item u-relative">
                         <span id="wEimc2ML23">
                            <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="Downvote" action_click="QuestionDownvote" action_target="{&quot;qid&quot;: 31450631, &quot;type&quot;: &quot;question&quot;}" id="__w2_wEimc2ML36_button">
                               <div className="ui_button_inner" id="__w2_wEimc2ML36_inner">
                                  <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                      ...
                      <div className="FacebookShareActionItem ActionItemComponent ItemComponent action_item secondary_item u-relative">
                         <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="Share on Facebook" id="__w2_wEimc2ML27_button">
                            <div className="ui_button_inner" id="__w2_wEimc2ML27_inner">
                               <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                      ...
                      <div className="ItemComponent ActionItemComponent TwitterShareActionItem action_item secondary_item u-relative">
                         <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="Share on Twitter" id="__w2_wEimc2ML30_button">
                            <div className="ui_button_inner" id="__w2_wEimc2ML30_inner">
                               <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                      ...
                      <div className="OverflowShareActionItem ActionItemComponent ItemComponent action_item secondary_item u-relative">
                         <div className="hover_menu hidden hover_share_menu show_nub" id="__w2_wEimc2ML31_menu">
                            <div className="hover_menu_contents" id="__w2_wEimc2ML31_menu_contents"> </div>
                         </div>
                         <div className="_QuickShare QuestionQuickShare HoverMenu" role="button" id="__w2_wEimc2ML31_link">
                            <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="More sharing options" id="__w2_wEimc2ML34_button">
                               <div className="ui_button_inner" id="__w2_wEimc2ML34_inner">
                                  <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                      ...
                      <div className="overflow action_item overflow_link u-relative u-pointer-events--auto">
                         <div className="overflow_link" id="__w2_w2cECm6L10_overflow_link">
                            <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="More options" id="__w2_wEimc2ML10_button">
                               <div className="ui_button_inner" id="__w2_wEimc2ML10_inner">
                                  <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                      ...
                      <div className="hover_menu hidden show_nub right_align fixed_menu_width no_body_attach" id="__w2_w2cECm6L10_overflow_menu">
                         <div className="hover_menu_contents lazy" id="__w2_w2cECm6L10_overflow_menu_contents" /></div>
                      </div>
                      <div className="action_bar_comments threaded_comments hidden" id="__w2_wEimc2ML11_wrapper" />
                         <div id="wEimc2ML12">
                            <div className="hidden answer_editor_wrapper" id="__w2_wEimc2ML13_add_answer_editor_wrapper" /></div>
                         </div>
                      </div>
                   </div>
                </div>
             ...
             <div id="w86ZXLZ520" />
                <div id="w86ZXLZ522" />
                   <div id="w86ZXLZ524" />
                      <div id="w86ZXLZ526" />
                         <div id="w86ZXLZ529" />
                            <div id="w86ZXLZ531" /></div>
                         </div>
                         <div className="UnifiedAnswerPagedList PagedListFoo unified" id="__w2_wiZEgLa49_paged_list">
                            <div className="dtqiddhhblocgivavhcp" id="__w2_wiZEgLa468_euvlwrfkkkemkajscgfw">
                               <div className="bdwxubvhzryrxtvfzcdn xfpnurkcyvpsdmxpkucg hylbifiepyrdopjimdht" style={{display: 'none !important'}}><div id="__w2_wiZEgLa469_pvwhvbzesvpcwjnocepu" style={{display: 'none !important'}}>
                               <div className="pqfjwetvetquhhkotdum">
                                  <div className="zgsbzxaqfhtajcuzjxah">
                                  </div>
                               </div>
                               <div className="copknanminfgwjvuiujs" style={{display: 'none !important'}}><div id="__w2_wiZEgLa475_mxemoajpxgmekxwulgzk" style={{display: 'none !important'}}>
                            </div>
                            <div className="gnktaszjpavpfrtktwjh">
                               <div id="wiZEgLa476">
                                  <div className="icon_action_bar" id="__w2_wiZEgLa477_action_bar">
                                  </div>
                               </div>
                            </div>
                         </div>
                      </div>
                      <div className="hbdfixaglfyecplgdypc hidden" id="__w2_wiZEgLa469_ocuxsdsklhlkszjzbvho">
                         <div className="content_dismiss_title">You dismissed this ad.</div>
                         <div className="content_dismiss_body">The feedback you provide will help us show you more relevant content in the future.</div>
                         <a className="undo" id="__w2_wiZEgLa469_zhfsqkvyjqelspmrrwwe">Undo</a>
                      </div>
                   </div>
                </div>
             </div>
             <div id="wiZEgLa410">
             <div className="AnswerWikiArea hidden" id="answer_wiki">
             <h3>Answer Wiki</h3>
             <div id="wiZEgLa416">
             <div className="AnswerWiki CreateAnswerWiki" id="__w2_wiZEgLa417_wiki">
             <div className="CreateAnswerWikiInlineEditor _WikiEditorCommon InlineEditor inline_editor_content hidden" id="__w2_wiZEgLa426_inline_editor_content">
                <span className="inline_editor_value">
                <span className="rendered_qtext" /></span>
             </div>
             <div className="rteditor inline_editor_content" id="__w2_wiZEgLa426_inline_editor_form">
             <div className="inline_editor_form">
             <div className="editor_wrapper" id="__w2_wiZEgLa427_editor_outer">
                <div className="AnswerWikiEditor Editor edit_latex web" id="__w2_wiZEgLa427_editor">
                   <div data-group="js-editable" w2cid="wiZEgLa427" id="__w2_wiZEgLa427_doc">
                   ...
                   <div className="editor_toolbar" id="__w2_wiZEgLa428_toolbar" style={{position: 'absolute', top: '0px', left: '0px'}}><div className="scroller" id="__w2_wiZEgLa428_scroller" style={{top: '-100%'}}>
                   <div className="bar bar_link_state" id="__w2_wiZEgLa428_bar0">
                      <div className="left u-flex-auto u-margin-right--sm" />
                         <div className="right" /></div>
                         <div className="bar bar_regular_state" id="__w2_wiZEgLa428_bar1">
                            <div className="left u-flex-auto u-margin-right--sm">
                               <div className="modifier" tooltip="Bold" id="__w2_wiZEgLa428_bold">
                               ...
                               <div className="modifier" tooltip="Italic" id="__w2_wiZEgLa428_italic">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                               ...
                               <div className="modifier" tooltip="Numbers" id="__w2_wiZEgLa428_ordered_list">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                               ...
                               <div className="modifier" tooltip="Bullets" id="__w2_wiZEgLa428_unordered_list">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            <div className="right">
                               <div className="modifier" tooltip="Video" id="__w2_wiZEgLa428_video">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                               ...
                               <div className="modifier disabled" tooltip="Photo" id="__w2_wiZEgLa428_image">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                           <defs>
                               ...
                               <div className="modifier" tooltip="Link" id="__w2_wiZEgLa428_link">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                               ...
                               <div className="modifier" tooltip="Show more" id="__w2_wiZEgLa428_overflow_show">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                           <g id="overflow" className="icon_svg-stroke" strokeWidth="1.5" stroke="#666" fill="none" fillRule="evenodd">
                         ...
                         <div className="bar bar_overflow_state" id="__w2_wiZEgLa428_bar2">
                            <div className="left u-flex-auto u-margin-right--sm">
                               <div className="modifier" tooltip="Mention user, topic or question" id="__w2_wiZEgLa428_mention">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                               ...
                               <div className="modifier" tooltip="Code" id="__w2_wiZEgLa428_code">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                               ...
                               <div className="modifier" tooltip="Math" id="__w2_wiZEgLa428_math">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            <div className="right">
                               <div className="modifier" tooltip="Undo" id="__w2_wiZEgLa428_undo">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                               ...
                               <div className="modifier" tooltip="Redo" id="__w2_wiZEgLa428_redo">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                               ...
                               <div className="modifier" tooltip="Show less" id="__w2_wiZEgLa428_overflow_hide">
                                  <span className="default_icon">
                                     <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                      ...
                      <div className="hidden" id="__w2_wiZEgLa428_storage">
                         <div className="u-inline-flex" id="__w2_wiZEgLa428_link_input_icon">
                         ...
                         <input className="u-ltr u-text-align--left" type="url" formNoValidate="formnovalidate" data-group="js-editable" placeholder="Enter URL" w2cid="wiZEgLa428" id="__w2_wiZEgLa428_link_input" />
                         <div className="cite" id="__w2_wiZEgLa428_cite"><input type="checkbox" formNoValidate="formnovalidate" data-group="js-editable" w2cid="wiZEgLa428" id="__w2_wiZEgLa428_is_citation" /><label htmlFor="__w2_wiZEgLa428_is_citation">Footnote</label></div>
                         <button type="button" id="__w2_wiZEgLa428_link_save">Add</button>
                         <div className="modifier" tooltip="Quote" id="__w2_wiZEgLa428_quote">
                            <span className="default_icon">
                               <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                         ...
                         <div className="modifier" tooltip="Indent" id="__w2_wiZEgLa428_indent">
                            <span className="default_icon">
                               <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                         ...
                         <div className="modifier" tooltip="Unindent" id="__w2_wiZEgLa428_deindent">
                            <span className="default_icon">
                               <span className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default" aria-hidden="true">
                                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                   ...
                   <div className="tooltip" id="__w2_wiZEgLa428_tooltip">
                      <div id="__w2_wiZEgLa428_tooltip_text" /></div>
                      <div className="hidden" id="__w2_wiZEgLa427_link_selector_wrapper">
                         <div className="LinkSelector Selector" tabIndex={-1} id="__w2_wiZEgLa429_wrapper">
                            <div className="link_selector_input">
                               <div className="selector_input_interaction">
                                  <div className="CharacterCounter fade_out" id="__w2_wiZEgLa465_counter_wrapper">
                                     <div className="counter" id="__w2_wiZEgLa465_counter">250</div>
                                  </div>
                                  <input className="selector_input text" type="text" defaultValue data-group="js-editable" placeholder="Search" w2cid="wiZEgLa429" id="__w2_wiZEgLa429_input" />
                                  <div className="selector_spinner hidden" id="__w2_wiZEgLa429_spinner">
                                     <div className="LoadingDots tiny">
                                        <div className="dot first" />
                                           <div className="dot second" />
                                              <div className="dot third" /></div>
                                     ...
                                     <div className="selector_results_container hidden" id="__w2_wiZEgLa429_results_container">
                                        <div className="selector_results_container_inner hidden" id="__w2_wiZEgLa429_results" />
                                           <div id="__w2_wiZEgLa429_empty_input_prompt" /></div>
                                        </div>
                                     </div>
                                  </div>
                               </div>
                               <div className="form_buttons" id="__w2_wiZEgLa426_inline_editor_buttons">
                                  <div className="inline_editor_buttons"><a className="inline_editor_button inline_editor_cancel_button" href="#" id="__w2_wiZEgLa426_inline_editor_cancel">Cancel</a><a className="submit_button" href="#" action_mousedown="InlineEditorAnswerAdd" id="__w2_wiZEgLa426_inline_editor_submit">Submit</a></div>
                               </div>
                            </div>
                         </div>
                      </div>
             ...
             <div id="wiZEgLa41">
             <div className="PagedListFoo UnifiedAnswerPagedList unified" id="__w2_wiZEgLa42_paged_list">
             <div className="paged_list_wrapper" id="__w2_wiZEgLa42_paged_list_wrapper">
             <div className="pagedlist_item" id="wiZEgLa43">
             <div data-clog-trigger="impression" data-clog-metadata="{&quot;action_log_target&quot;: {&quot;type&quot;: 4, &quot;hash&quot;: &quot;answer_ranking|890043703&quot;}}" data-clog-event-type="ActionLogImpression" id="__w2_wzwmJKBZ4_actionable" data-clog-processed={1}>
             <div id="wzwmJKBZ5">
             <div data-clog-trigger="impression" data-clog-metadata="{&quot;object_view&quot;: {&quot;view_tracking_key&quot;: &quot;a-104359258&quot;, &quot;view_tracking_hash&quot;: &quot;c1a322bdf84ba45aeedf1ee577b45fad&quot;}}" data-clog-event-type="ObjectView" data-clog-processed={1}>
             <div id="wzwmJKBZ8">
             ...
             { this.state.answers.map(answer => 
                <div className="Answer AnswerBase" data-clog-metadata="{}" id="__w2_wzwmJKBZ9_answer">
                <div>
                <div id="wzwmJKBZ10">
                   ...
                   <div className="ui_layout_photo_text u-flex ui_layout_size--small">
                      <div className="ui_layout_photo_wrapper u-flex-none">
                         <div className="ui_layout_photo u-relative">
                            <div className="u-flex-inline" id="wzwmJKBZ22">
                               <div className="hover_menu hidden show_nub" id="__w2_wzwmJKBZ36_menu">
                                  <div className="hover_menu_contents" id="__w2_wzwmJKBZ36_menu_contents"> 
                                  </div>
                               </div>
                               <span className="photo_tooltip u-inline" id="__w2_wzwmJKBZ36_link">
             <a className="u-flex-inline" href="/profile/Brian-Lee-2">
             <span className="ui_avatar u-flex-inline ui_avatar--large u-flex-none">
             <img className="ui_avatar_photo ui_avatar--border-circular" src="https://qph.fs.quoracdn.net/main-thumb-135803-100-hfwmdtdhabdgeqjarswxljarsjkomepm.jpeg" alt="Brian Lee" />
             </span>
             </a>
             </span>
             </div>
             ...
             <div className="u-margin-right--sm u-width--100"><div className="feed_item_answer_user"><span id="wzwmJKBZ24"><span id="wzwmJKBZ29"><div className="hover_menu hidden white_bg show_nub" id="__w2_wzwmJKBZ30_menu"><div className="hover_menu_contents" id="__w2_wzwmJKBZ30_menu_contents"> </div></div>
             <span id="__w2_wzwmJKBZ30_link">
             <a className="user" href="/profile/Brian-Lee-2" action_mousedown="UserLinkClickthrough" id="__w2_wzwmJKBZ30_name_link">{answer.owner}</a></span></span></span></div>
             <span className="credibility_wrapper"><div className="AnswerCredibilityFacts CredibilityFacts pass_color_to_child_links"><span id="wzwmJKBZ31"><a className="answer_permalink" action_mousedown="AnswerPermalinkClickthrough" href="/Who-first-invented-the-money-Who-was-the-person-who-invented-or-made-it-How-much-was-he-paid/answer/Brian-Lee-2" id="__w2_wzwmJKBZ32_link">Answered Oct 17, 2018</a></span></div></span></div><div id="__w2_wzwmJKBZ12_follow_button_section"><div className="u-relative icon_follow_button_wrapper"><div className="u-absolute u-absolute--center u-border-radius--ellipse u-padding-right--xs u-padding-left--xs icon_follow_button" id="__w2_wzwmJKBZ12_follow_button"><span id="wzwmJKBZ26"><a className="ui_button u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--light_blue ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="Follow Brian" action_target="{&quot;type&quot;: &quot;user&quot;, &quot;uid&quot;: 135803}" id="__w2_wzwmJKBZ40_button"><div className="ui_button_inner" id="__w2_wzwmJKBZ40_inner"><div className="ui_button_icon_wrapper u-relative u-flex-inline"><div id="__w2_wzwmJKBZ40_icon"><span className="ui_button_icon ui_button-unpressed_icon" aria-hidden="true"><svg width={24} height={24} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
             ...
             </svg></span></div></div></div></a></span></div></div></div></div></div></div><div id="__w2_wzwmJKBZ28_suggested_section" /></div></div>
             <div id="__w2_wzwmJKBZ9_answer_content">
             <div id="wzwmJKBZ13">
             <div className="Expandable Toggle AnswerExpandable AnswerEditableExpandable SimpleToggle" id="__w2_wzwmJKBZ14__truncated">
             <div id="wBch4VPF4">
             <div className="inline_editor_content" id="__w2_wBch4VPF5_content">
                <span className="inline_editor_value" id="__w2_wBch4VPF5_answer_content">
                <div className="ExpandedContent ExpandedAnswer" id="__w2_wBch4VPF7_expanded_content">
                   <div id="wBch4VPF9" />
                      ...
                      <div id="wBch4VPF13">
                         <div className="ReadingContentFooter ContentFooter AnswerFooter" id="__w2_wBch4VPF14_content_footer">
                            <span>664 views</span>
                            <span id="wBch4VPF17" />
                            <span id="wBch4VPF19" />
                         </div>
                      </div>
                      <div id="__w2_wBch4VPF7_survey_wrapper" /><div className="hidden" id="__w2_wBch4VPF16_highlight_menu" /></div></span><div className="hidden" id="__w2_wBch4VPF5_loading"><span className="loading">Loading…</span></div></div>
                      <div className="hidden" id="__w2_wBch4VPF5_editor" /></div>
                   </div>
                </div>
             </div>
             <div>
             <div id="wzwmJKBZ15">
             <div style={{height: '0px', margin: '0px', padding: '0px', clear: 'both', display: 'block'}} /><div className="icon_action_bar with_metabar" id="__w2_wzwmJKBZ16_action_bar" style={{position: 'relative'}}>
             <div id="wTzJejgH23">
             <div className="ItemComponent Metabar AnswerMetabarPrependItem u-relative">
                <div className="prepend_item_inner pass_color_to_child_links" id="__w2_wTzJejgH24_wrapper">
                   <div className="prepend_item_content u-relative" id="__w2_wTzJejgH24_content">
                      <span className="meta_bar_pre_upvote_wrapper" id="__w2_wTzJejgH24_pre_upvote_text">
                         <div id="wr8jPOSk45" />
                      </span>
                      <span className="meta_bar_post_upvote_wrapper hidden" id="__w2_wTzJejgH24_post_upvote_text"><div id="wr8jPOSk47"><div className="unstyled_social_bar"><div className="photos"><div className="ui_badge_group_wrapper"><span className="ui_avatar u-flex-inline ui_avatar--small u-flex-none"><img className="ui_avatar_photo ui_avatar--border-circular" src="https://qph.fs.quoracdn.net/main-thumb-782622776-50-izcdaymwbtomzguzorfwyoknxfqoqixc.jpeg" /></span></div></div><span className="reason_line">You upvoted this</span></div></div></span></div>
                   </div>
                </div>
             </div>
             <div className="action_bar_inner u-flex">
                <span id="wTzJejgH25">
                   <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--blue ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon u-tap-highlight--none ui_button--has_icon" href="#" role="button" action_click="AnswerUpvote" action_target="{&quot;aid&quot;: 104359258, &quot;type&quot;: &quot;answer&quot;}" id="__w2_wFDFurfC8_button">
                      <div className="ui_button_inner" id="__w2_wFDFurfC8_inner">
                         <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                            <div className="u-hardware-accelerated" id="__w2_wFDFurfC8_icon">
                               <span className="ui_button_icon" aria-hidden="true">
                                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                     <g id="upvote" className="icon_svg-stroke icon_svg-fill" strokeWidth="1.5" stroke="#666" fill="none" fillRule="evenodd" strokeLinejoin="round">
                         ...
                         <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wFDFurfC8_label">Upvote</span><span className="ui_button_count hidden ui_button_count--animated" aria-hidden="true" id="__w2_wFDFurfC8_count_wrapper"><span className="bullet"> · </span><span className="ui_button_stacked_counts" id="__w2_wFDFurfC8_count"><span className="ui_button_count_optimistic_count">0</span><span className="ui_button_count_optimistic_count">1</span></span></span></div>
                      </div>
                   </a>
                </span>
                <div className="QuoraShareActionItem ItemComponent ActionItemComponent action_item u-relative">
                   <div id="wTzJejgH32">
                      <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon" href="#" role="button" id="__w2_wTzJejgH41_button">
                         <div className="ui_button_inner" id="__w2_wTzJejgH41_inner">
                            <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                            ...
                            <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wTzJejgH41_label">Share</span><span className="ui_button_count hidden" aria-hidden="true" id="__w2_wTzJejgH41_count_wrapper"><span className="bullet"> · </span><span className="ui_button_count_inner" id="__w2_wTzJejgH41_count">0</span></span></div>
                         </div>
                      </a>
                      <div id="__w2_wTzJejgH33_quora_share_tooltip" /></div>
                   </div>
                   <div className="ItemComponent ActionItemComponent DownvoteActionItem action_item secondary_item u-relative">
                      <span id="wTzJejgH34">
                         <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="Downvote" action_click="AnswerDownvote" action_target="{&quot;aid&quot;: 104359258, &quot;type&quot;: &quot;answer&quot;}" id="__w2_wTzJejgH43_button">
                            <div className="ui_button_inner" id="__w2_wTzJejgH43_inner">
                               <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                   ...
                   <div className="OverflowShareActionItem ActionItemComponent ItemComponent action_item secondary_item u-relative">
                      <div id="wTzJejgH36">
                         <div className="hover_menu hidden u-right--0 show_nub right_align" id="__w2_wTzJejgH37_menu">
                            <div className="hover_menu_contents" id="__w2_wTzJejgH37_menu_contents"> </div>
                         </div>
                         <div className="_QuickShare HoverMenu AnswerQuickShare" role="button" id="__w2_wTzJejgH37_link">
                            <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="More sharing options" id="__w2_wTzJejgH40_button">
                               <div className="ui_button_inner" id="__w2_wTzJejgH40_inner">
                                  <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                   ...
                   <div className="action_bar_inner_spacer u-margin-left--auto">&nbsp;</div>
                   <div className="overflow action_item overflow_link u-relative u-pointer-events--auto">
                      <div className="overflow_link" id="__w2_wzwmJKBZ16_overflow_link">
                         <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="More options" id="__w2_wTzJejgH31_button">
                            <div className="ui_button_inner" id="__w2_wTzJejgH31_inner">
                               <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                   ...
                   <div className="hover_menu hidden show_nub right_align fixed_menu_width no_body_attach" id="__w2_wzwmJKBZ16_overflow_menu">
                      <div className="hover_menu_contents lazy" id="__w2_wzwmJKBZ16_overflow_menu_contents" /></div>
                   </div>
                </div>
             </div>
             <div id="wzwmJKBZ20">
             ...
             <div id="wzwmJKBZ33">
             <div className="expanded_wrapper" id="__w2_wFDFurfC2_expanded_wrapper">
             ...
             <div data-group="js-editable" w2cid="w1SM6R3W27">
                 <div className="doc empty"  data-kind="doc" placeholder="Write your answer" >
                     {/* <div className="section" data-type="plain" data-indent={0} data-kind="section" data-dir="LTR" id="editable" contentEditable="true">
                        ...
                        <textarea id="one" name = "comment" style={{resize: "none", backgroundColor: "rgba(0, 0, 0, 0)", borderColor: "rgba(0, 0, 0, 0)"}} onChange={this.onChange}/>
             ...
             <div id="__w2_wR5L77UZ5_added_comments" /></div>
             <div id="__w2_wR5L77UZ2_container_featured">
             <div className="TCommentListWrapper FeaturedTCommentListWrapper" id="__w2_wR5L77UZ7_comment_list_wrapper">
             <div className="comment_list comment_list_level_0" id="__w2_wR5L77UZ7_comment_list">
             ...
             <div className="full_comment_text" id="__w2_wR5L77UZ21_full_comment_text">
             <div className="TCommentTruncatedInlineEditor InlineEditor TCommentFullTextInlineEditor inline_editor_content" id="__w2_wR5L77UZ33_inline_editor_content">
                <span className="inline_editor_value">
             ...
             <div className="rteditor inline_editor_content threaded_inline_editor hidden" id="__w2_wR5L77UZ33_inline_editor_form">
             <div className="inline_editor_form">
             <div className="editor_wrapper" id="__w2_wR5L77UZ41_editor_outer">
             <div className="Comment Editor edit_latex web" id="__w2_wR5L77UZ41_editor">
             <div data-group="js-editable" w2cid="wR5L77UZ41" id="__w2_wR5L77UZ41_doc">
                <div className="doc" contentEditable="true" data-kind="doc" placeholder>
                   <div className="section" data-type="plain" data-dir="LTR" data-indent={0} data-kind="section">
                      <div className="span" data-kind="span">
             ...
             <input type="file" accept=".jpg, .png, .jpeg, .gif, .bmp|images/*" multiple style={{display: 'none'}} data-group="js-editable" w2cid="wR5L77UZ41" id="__w2_wR5L77UZ41_file" />
             <div className="drop_zone hidden" id="__w2_wR5L77UZ41_drop_zone" />
             <div className="hidden" id="__w2_wR5L77UZ41_link_selector_wrapper">
             <div className="Selector LinkSelector" tabIndex={-1} id="__w2_wR5L77UZ46_wrapper">
                <div className="link_selector_input">
                   <div className="selector_input_interaction">
                      <div className="CharacterCounter fade_out" id="__w2_wR5L77UZ47_counter_wrapper">
                         <div className="counter" id="__w2_wR5L77UZ47_counter">250</div>
                      </div>
                      <input className="selector_input text" type="text" defaultValue data-group="js-editable" placeholder="Search" w2cid="wR5L77UZ46" id="__w2_wR5L77UZ46_input" />
                      <div className="selector_spinner hidden" id="__w2_wR5L77UZ46_spinner">
                         <div className="LoadingDots tiny">
                            <div className="dot first" />
                               <div className="dot second" />
                                  <div className="dot third" /></div>
                         ...
                         <div className="selector_results_container hidden" id="__w2_wR5L77UZ46_results_container">
                            <div className="selector_results_container_inner hidden" id="__w2_wR5L77UZ46_results" />
                               <div id="__w2_wR5L77UZ46_empty_input_prompt" /></div>
                            </div>
                         </div>
                      </div>
                   </div>
                   <div className="u-flex u-margin-top--sm" id="__w2_wR5L77UZ33_inline_editor_buttons">
                      <div className="u-flex u-margin-left--auto u-flex-align--center u-padding-right--md" id="__w2_wR5L77UZ33_inline_editor_cancel">
                         <a className="ui_button u-nowrap ui_button--styled ui_button--SimpleLinkStyle ui_button--SimpleLinkStyle--gray ui_button--size_small u-inline-block" href="#" role="button" id="__w2_wR5L77UZ42_button">
                            <div className="ui_button_inner" id="__w2_wR5L77UZ42_inner">
                               <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wR5L77UZ42_label">Cancel</span></div>
                            </div>
                         </a>
                      </div>
                      <div className="u-flex" id="__w2_wR5L77UZ33_inline_editor_submit">
                         <a className="ui_button u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--bright_blue ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon" href="#" role="button" id="__w2_wR5L77UZ43_button">
                            <div className="ui_button_inner" id="__w2_wR5L77UZ43_inner">
                               <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wR5L77UZ43_label">Update</span></div>
                            </div>
                         </a>
                      </div>
                   </div>
             ...
             <div id="wR5L77UZ34">
             <div id="wR5L77UZ37">
             <div className="icon_action_bar" id="__w2_wR5L77UZ38_action_bar">
             ...
             <div id="__w2_wR5L77UZ22_added_comments" /></div>
                                           ...
                                           <div id="__w2_wR5L77UZ7_comment_list_first_level_placeholder_2" />
                                              <div id="__w2_wR5L77UZ7_collapsed_link" /></div>
                                           </div>
                                        </div>
                                        <div className="hidden" id="__w2_wR5L77UZ2_container_all" /></div>
                                     </div>

                                  </div>
                                  <a className="comments_preview_toggle hidden" href="#" id="__w2_wFDFurfC2_toggle_link" style={{minHeight: '66px'}}>
             ...
             <div className="pagedlist_item" id="wiZEgLa418" style={{display: 'none !important'}}>
             <div id="__w2_wiZEgLa423_paged_list">
                <div className="dtqiddhhblocgivavhcp" id="__w2_wiZEgLa481_ssyazljnqqkzlbpixvdm">
                   <div className="bdwxubvhzryrxtvfzcdn xfpnurkcyvpsdmxpkucg nqhjqevihbtsnvakbejl">
                      <div id="__w2_wiZEgLa482_zgizhhdggoqasuxipigc">
                         <div className="pqfjwetvetquhhkotdum">
                            <div className="zgsbzxaqfhtajcuzjxah"><a className="ifoicfsetvssmlueffog otgplzscasitqutfwsgd" href="http://morrieved-workindow.com/a32067f9-017b-41bb-bb63-3a828199cdfc?camp=TF&AdSet=3D&Ad=Ad10" target="_blank" rel="noopener nofollow" id="__w2_wiZEgLa494_skecrmpbpmfpqrkxdods">
                               </a>
                            </div>
                         </div>
                         <div className="ueuddlxsbvthnlfqvgii">
                            <a className="ifoicfsetvssmlueffog" href="http://morrieved-workindow.com/a32067f9-017b-41bb-bb63-3a828199cdfc?camp=TF&AdSet=3D&Ad=Ad10" target="_blank" rel="noopener nofollow" id="__w2_wiZEgLa484_pamlrkmmhbzslulylone">
                               <div id="__w2_wiZEgLa485_woykigdvghfopxmvemvp">
                               </div>
                            </a>
                            <a className="ifoicfsetvssmlueffog" href="http://morrieved-workindow.com/a32067f9-017b-41bb-bb63-3a828199cdfc?camp=TF&AdSet=3D&Ad=Ad10" target="_blank" rel="noopener nofollow" id="__w2_wiZEgLa486_njuifywrtazxehwcmwjg">
                         ...
                         <div className="copknanminfgwjvuiujs">
                            ...
                            <div className="gnktaszjpavpfrtktwjh">
                               <div id="wiZEgLa489">
                                  <div className="icon_action_bar" id="__w2_wiZEgLa490_action_bar">
                                     <div className="action_bar_inner u-flex">
                                        <div className="overflow action_item overflow_link u-relative u-pointer-events--auto">
                                        </div>
                                        <div className="hover_menu hidden show_nub right_align fixed_menu_width no_body_attach" id="__w2_wiZEgLa490_overflow_menu">
                                           <div className="hover_menu_contents lazy" id="__w2_wiZEgLa490_overflow_menu_contents" /></div>
                                        </div>
                                     </div>
                                  </div>
                               </div>
                         ...
                         <div className="hbdfixaglfyecplgdypc hidden" id="__w2_wiZEgLa482_xmlsxlmiljiqwplqqste">
                            <div className="content_dismiss_title">You dismissed this ad.</div>
                            <div className="content_dismiss_body">The feedback you provide will help us show you more relevant content in the future.</div>
                            <a className="undo" id="__w2_wiZEgLa482_gjbglyxdjtqxyzjlmehr">Undo</a>
                         </div>
                      </div>
                   </div>
                </div>
             ...
             <div className="pagedlist_item" id="wdxQ74p51">
                <div data-clog-trigger="impression" data-clog-metadata="{&quot;action_log_target&quot;: {&quot;type&quot;: 4, &quot;hash&quot;: &quot;answer_ranking|48446295&quot;}}" data-clog-event-type="ActionLogImpression" id="__w2_wlQU3waT4_actionable" data-clog-processed={1}>
                   <div id="wlQU3waT5">
                      <div data-clog-trigger="impression" data-clog-metadata="{&quot;object_view&quot;: {&quot;view_tracking_key&quot;: &quot;a-91501741&quot;, &quot;view_tracking_hash&quot;: &quot;88bf46b1601be3398e35fb93616e2077&quot;}}" data-clog-event-type="ObjectView" data-clog-processed={1}>
                         <div id="wlQU3waT8">
             ...
             <div className="pagedlist_item" id="wdxQ74p54" />
                <div className="pagedlist_item" id="wdxQ74p56">
                   <div data-clog-trigger="impression" data-clog-metadata="{&quot;action_log_target&quot;: {&quot;type&quot;: 4, &quot;hash&quot;: null}}" data-clog-event-type="ActionLogImpression" id="__w2_wYjkE3sr4_actionable" data-clog-processed={1}>
                      <div id="wYjkE3sr5">
                         <div className="SimpleToggle CollapsedAnswersSectionCollapsed Toggle" id="__w2_wYjkE3sr9__truncated" />
                            <div className="SimpleToggle CollapsedAnswersSectionCollapsed Toggle hidden" id="__w2_wYjkE3sr9__expanded" /></div>
                         </div>
                      </div>
                   </div>
                   ...
                   <div className="spinner_display_area hidden" id="__w2_wiZEgLa42_spinner">
                      <div className="LoadingDots regular">
                         <div className="dot first" />
                            <div className="dot second" />
                               <div className="dot third" /></div>
