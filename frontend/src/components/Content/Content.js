...
<div className="UserContentFilterTopics UserContentFilter">
   ...
   </div><div className="UserContentFilterTime UserContentFilter"><h3>By Year</h3><ul id="__w2_wsawratU29_filter_links"><li className="filter_option"><a className="selected filter_option_link" href="#" data-value="all_time">All Time</a></li><li className="filter_option"><a className=" filter_option_link" href="#" data-value={2019}>2019</a></li></ul></div><div className="UserContentFilterSortOrder UserContentFilter"><h3>Sort Order</h3><ul id="__w2_wsawratU31_filter_links"><li className="filter_option"><a className="selected filter_option_link" href="#" data-value="newest_first">Newest First</a></li><li className="filter_option"><a className=" filter_option_link" href="#" data-value="oldest_first">Oldest First</a></li></ul></div></div></div><div className="layout_3col_center"><h3>Your Content</h3><div className="user_content_list_section"><div id="__w2_wsawratU18_list_wrapper"><div className="PagedList UserContentList" id="wsawratU23"><div className="pagedlist_item" id="wzr1YmKw2"><div className="PagedListItem UserContentListItem"><span className="title"><span id="wzr1YmKw6"><a className="question_link" href="/unanswered/Trends-in-Silicon-Valley" target="_top" action_mousedown="QuestionLinkClickthrough" id="__w2_wzr1YmKw7_link"><span className="ui_content_title unstyled_ui_title"><span className="ui_qtext_rendered_qtext">Trends in Silicon Valley?</span></span></a></span></span><div className="metadata">Asked just now</div></div></div><div id="wzr1YmKw4"><div className="PagedListMoreButton" id="__w2_wzr1YmKw5_paged_list_more_button"><div className="pager_next" id="__w2_wzr1YmKw5_loading"><div className="__wn2_loading"><span className="__wn2_loading_spinner" /></div></div><div className="pager_next action_button row hidden" id="__w2_wzr1YmKw5_more">More</div><div className="pager_sentinel" id="__w2_wzr1YmKw5_sentinel" /></div></div></div></div></div></div></div></div></div>
</div>
