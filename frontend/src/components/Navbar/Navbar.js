   ...
   <div className="SiteHeaderNavItem FeedNavItem HoverMenu">
      ...
      <a className= {this.props.Home} href="https://www.quora.com/" target id="__w2_wGp3JsZF2_link">
         <div className="u-margin-right--xs u-flex-inline">
            <span className={this.props.Home_Color} aria-hidden="true">
               <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
<span id="wGp3JsZF3">
   ...
   <Link to = "/answer"className={this.props.Answer}  target id="__w2_wGp3JsZF4_link">
      <div className="u-margin-right--xs u-flex-inline">
         <span className={this.props.Answer_Color} aria-hidden="true">
            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
