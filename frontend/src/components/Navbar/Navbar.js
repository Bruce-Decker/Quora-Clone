...
//  }
  ...
  onSubmit = () => {
    ...
    axios.post('/question/createQuestion', data)
         .then(res => {
                ...
                <div className="right_contents u-flex u-flex-align--center">
                  <div className="ask_bar">
                    ...
                    >
                      ...
                      {/* input */}
        {this.state.searchCriteria == "topic" || this.state.searchCriteria == "question" ?
                        <input
                          className="selector_input text"
                          type="text"
                          data-lpignore="true"
...
{this.state.showSearchModal && this.state.searchCriteria == "question" ? 
<div className="lookup_bar_results_wrapper" id="__w2_wTZ9qVEp12_results_wrapper" style={{width: '246.578px'}}>
<div className="results_wrapper">
   <div className="hidden resistance_wrapper server_message" id="__w2_wTZ9qVEp12_server_message">
      <div className="fixit_title" id="__w2_wTZ9qVEp12_server_message_title" /><span className="fixit_note" id="__w2_wTZ9qVEp12_server_message_note" /></div>
      <div className="interstitials_and_results">
         ...
         <div className="results" id="__w2_wTZ9qVEp12_results">
            ...
            {savedAllSearchQuestions.filter(searchingQuestion(this.state.searchValue)).map(question =>
             <Link to = {`/question/${question.question_id}`}>
               <li className="selector_result tribe" id="__w2_w4N3kpSm1_result_5">
                  ...
                  <div data-clog-trigger="impression" data-clog-metadata="{&quot;action_log_target&quot;: {&quot;type&quot;: 39, &quot;hash&quot;: &quot;1140612010|tribe|194|-1718384057|0&quot;}}" data-clog-event-type="ActionLogImpression" id="__w2_w4N3kpSm7_actionable" data-clog-processed={1}>
                     ...
                     <span className="rendered_qtext"> {question.question} </span> 
                     <div className="u-inline-block u-margin-left--xs">
...
: null }
 ...
 {this.state.showSearchModal && this.state.searchCriteria == "people" ? 
<div className="lookup_bar_results_wrapper" id="__w2_wTZ9qVEp12_results_wrapper" style={{width: '246.578px'}}>
<div className="results_wrapper">
   <div className="hidden resistance_wrapper server_message" id="__w2_wTZ9qVEp12_server_message">
      <div className="fixit_title" id="__w2_wTZ9qVEp12_server_message_title" /><span className="fixit_note" id="__w2_wTZ9qVEp12_server_message_note" /></div>
      <div className="interstitials_and_results">
         ...
         <div className="results" id="__w2_wTZ9qVEp12_results">
            ...
            {savedAllProfiles.filter(searchingProfile(this.state.searchValue)).map(profile =>
             <Link to = {`/profile/${profile.email}`}>
               <li className="selector_result tribe" id="__w2_w4N3kpSm1_result_5">
                  ...
                  <div data-clog-trigger="impression" data-clog-metadata="{&quot;action_log_target&quot;: {&quot;type&quot;: 39, &quot;hash&quot;: &quot;1140612010|tribe|194|-1718384057|0&quot;}}" data-clog-event-type="ActionLogImpression" id="__w2_w4N3kpSm7_actionable" data-clog-processed={1}>
                     ...
                     <span className="rendered_qtext"> {profile.first_name} </span> 
                     <div className="u-inline-block u-margin-left--xs">
...
<form onSubmit = {this.onSubmit} className="ui form">
              ...
              <div className="modal_header only_close_button">
                <div className="modal_close" id="__w2_wnDsdkCJ1_close">
                    <Link className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="Close" id="__w2_wnDsdkCJ2_button" onClick = {this.closeModal}>
                    <div className="ui_button_inner" id="__w2_wnDsdkCJ2_inner">
                      <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                ...
                <div className="tabs_header u-flex-inline u-flex-row">
                    <div className="tab selected" id="__w2_wnDsdkCJ1_question_tab">Add Question</div>
                    <div className="tab" id="__w2_wnDsdkCJ1_link_tab">Share Link</div>
                </div>
              </div>
              <div className="modal_content modal_content_tabs" id="__w2_wnDsdkCJ1_content">
              <div id="__w2_wnDsdkCJ1_content_inner_question">
              <div className="ask_modal_header u-flex">
                <div className="user_asks_header"><span className="user_action"><span className="IdentityNameWithPhoto NameWithPhoto"><span id="wnDsdkCJ11"><span className="photo_tooltip IdentityPhoto PhotoSpan Photo HoverMenu" id="__w2_wnDsdkCJ12_link"><a href="/profile/Bruce-Decker-12" id="__w2_wnDsdkCJ15_link"><img className="profile_photo_img" src="https://qph.fs.quoracdn.net/main-thumb-782622776-50-yelobhtpkmogsmcnnoowexfiripfrhwb.jpeg" alt="Bruce Decker" height={50} width={50} /></a></span></span><span id="wnDsdkCJ13"><span id="__w2_wnDsdkCJ14_link"><a className="user" href="/profile/Bruce-Decker-12" action_mousedown="UserLinkClickthrough" id="__w2_wnDsdkCJ14_name_link">Bruce Decker</a></span></span></span> asked</span></div>
                <div className="mini_distribution_switcher">
                    <div className="u-relative button_area" id="__w2_wnDsdkCJ4_pop_over_link">
                      <span className="multi_state_button" id="__w2_wnDsdkCJ4_button_0">
                          <a className="ui_button u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--gray ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon" href="#" role="button" id="__w2_wnDsdkCJ32_button">
                            <div className="ui_button_inner" id="__w2_wnDsdkCJ32_inner">
                                <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                  <div id="__w2_wnDsdkCJ32_icon">
                                      <span className="ui_button_icon" aria-hidden="true">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                            <g stroke="none" fill="none" fillRule="evenodd">
                                              <g className="icon_svg-stroke" transform="translate(4.000000, 4.000000)" stroke="#666666" strokeWidth="1.5">
                                ...
                                <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wnDsdkCJ32_label">Public</span></div>
                      ...
                      <span className="multi_state_button hidden" id="__w2_wnDsdkCJ4_button_1">
                          <a className="ui_button u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--gray ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon" href="#" role="button" id="__w2_wnDsdkCJ33_button">
                            <div className="ui_button_inner" id="__w2_wnDsdkCJ33_inner">
                                <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                ...
                                <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wnDsdkCJ33_label">Anonymous</span></div>
                                <span className="ui_button-chevron_suffix u-flex-inline ui_button-vertically_flippable_chevron" aria-hidden="true">
                                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                      <g className="icon_svg-stroke" stroke="#666" strokeWidth="1.5" fill="none" fillRule="evenodd" strokeLinecap="round">
                                        <polyline points="5 8.5 12 15.5 19.0048307 8.5" />
                      ...
                      <span className="multi_state_button hidden" id="__w2_wnDsdkCJ4_button_2">
                          <a className="ui_button u-nowrap ui_button--styled ui_button--PillStyle ui_button--PillStyle--gray ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon" href="#" role="button" id="__w2_wnDsdkCJ34_button">
                            <div className="ui_button_inner" id="__w2_wnDsdkCJ34_inner">
                                <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                ...
                                <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wnDsdkCJ34_label">Limited</span></div>
                                <span className="ui_button-chevron_suffix u-flex-inline ui_button-vertically_flippable_chevron" aria-hidden="true">
                                  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                      <g className="icon_svg-stroke" stroke="#666" strokeWidth="1.5" fill="none" fillRule="evenodd" strokeLinecap="round">
                                        <polyline points="5 8.5 12 15.5 19.0048307 8.5" />
                    ...
                    <div className="ui_popup use_new_menu ui_popup_menu hidden ui_popup--show_nub ui_popup_align--right" id="__w2_wnDsdkCJ4_pop_over_menu">
                      <div className="ui_menu_overflowmenu u-bg--white u-border-all u-padding-top--sm u-padding-bottom--sm" id="__w2_wnDsdkCJ4_menu_contents">
                          <div id="wnDsdkCJ16">
                            <a href="#" id="__w2_wnDsdkCJ17_pop_over_menu_item">
                                <span className="ui_menu_item_checkmark error" id="__w2_wnDsdkCJ17_contents">
                                  <div id="wnDsdkCJ35">
                                      <div className="ui_menu_item u-block u-padding-right--md u-text--gray-dark u-sans-font-main--small pass_color_to_child_links">
                                        <div className="ui_menu_item_text u-inline-block no_icon">
                          ...
                          <div id="wnDsdkCJ18">
                            <a href="#" id="__w2_wnDsdkCJ19_pop_over_menu_item">
                          ...
                          <div id="wnDsdkCJ20">
                            <a href="#" id="__w2_wnDsdkCJ21_pop_over_menu_item">
              ...
              <div className="TypersearchESDuplicateQuestionSelector AskQuestionSelector Selector" tabIndex={-1} id="__w2_wnDsdkCJ5_wrapper">
              <div className="selector_input_interaction">
              <div className="CharacterCounter fade_out" id="__w2_wnDsdkCJ22_counter_wrapper">
                <div className="counter" id="__w2_wnDsdkCJ22_counter">250</div>
              </div>
              ...
              <textarea className="selector_input text" name = "question" onChange = {this.onChange} type="text" rows={1} title="Start your question with &quot;What&quot;, &quot;How&quot;, &quot;Why&quot;, etc." data-group="js-editable" placeholder="Start your question with &quot;What&quot;, &quot;How&quot;, &quot;Why&quot;, etc." w2cid="wnDsdkCJ5" id="__w2_wnDsdkCJ5_input" style={{overflow: 'hidden', overflowWrap: 'break-word', height: '31px'}} defaultValue={""} />
              ...
              <div className="selector_spinner hidden" id="__w2_wnDsdkCJ5_spinner">
                <div className="LoadingDots tiny">
                    <div className="dot first" />
                      <div className="dot second" />
                    ...
                    <div className="selector_results_container is_inline" id="__w2_wnDsdkCJ5_results_container" style={{overflowY: 'auto', height: 'auto'}}>
                    <div className="selector_results_container_inner hidden" id="__w2_wnDsdkCJ5_results" />
                      <div id="__w2_wnDsdkCJ5_empty_input_prompt" /></div>
                    </div>
                    <div id="wnDsdkCJ6">
                      <div className="QuestionSourceEdit">
                          <div className="source_editor" id="__w2_wnDsdkCJ7_toolbar">
                            <div className="bar bar_link_state u-flex u-flex-align--center">
                                <span className="ui_icon ui_icon_color--gray_light ui_icon_size--small ui_icon_outline--default" aria-hidden="true">
                                  
                                </span>
                                
                                <input type="checkbox" name="General_Topic" onClick={ () => { this.setState({ General_Topic: !this.state.General_Topic }) } }/> <br/> <p>General </p>
                                <input type="checkbox" name="Science_Topic"  onClick={ () => { this.setState({ Science_Topic: !this.state.Science_Topic }) } }/> <p>Science and Technology</p>

                                <input type="checkbox" name="Politics_Topic"  onClick={ () => { this.setState({ Politics_Topic: !this.state.Politics_Topic }) } } /> <p>Politics</p>
                                <input type="checkbox" name="Psychology_Topic" onClick={ () => { this.setState({ Psychology_Topic: !this.state.Psychology_Topic }) } } /> <p>Psychology</p>
                                <input type="checkbox" name="History_Topic" onClick={ () => { this.setState({ History_Topic: !this.state.History_Topic }) } }  /> <p>History</p>
                ...
                <div className="hidden" id="__w2_wnDsdkCJ1_content_inner_link">
                    <div className="QuoraShareEditor">
                      <div className="ask_modal_header">
                          <div className="user_asks_header"><span className="user_action"><span className="IdentityNameWithPhoto NameWithPhoto"><span id="wnDsdkCJ27"><span className="photo_tooltip IdentityPhoto PhotoSpan Photo HoverMenu" id="__w2_wnDsdkCJ28_link"><a href="/profile/Bruce-Decker-12" id="__w2_wnDsdkCJ31_link"><img className="profile_photo_img" src="https://qph.fs.quoracdn.net/main-thumb-782622776-50-yelobhtpkmogsmcnnoowexfiripfrhwb.jpeg" alt="Bruce Decker" height={50} width={50} /></a></span></span><span id="wnDsdkCJ29"><span id="__w2_wnDsdkCJ30_link"><a className="user" href="/profile/Bruce-Decker-12" action_mousedown="UserLinkClickthrough" id="__w2_wnDsdkCJ30_name_link">Bruce Decker</a></span></span></span> shared</span></div>
                      </div>
                      <div className="selector_input_interaction">
                          <div cname="quora_share_editor" id="share_input"><textarea className="selector_input selector_input_link_comment" autofocus="True" name="description" rows={1} type="text" cname="quora_share_editor" data-group="js-editable" placeholder="Say something about this..." w2cid="wnDsdkCJ9" id="__w2_wnDsdkCJ9_share_comment" style={{overflowX: 'hidden', overflowWrap: 'break-word'}} defaultValue={""} /></div>
                          <div className="CharacterCounter" id="__w2_wnDsdkCJ26_counter_wrapper">
                            <div className="counter" id="__w2_wnDsdkCJ26_counter">250</div>
                          </div>
                      </div>
                    </div>
                    <div className="url_input_box u-flex u-flex-column u-margin-top--md" id="__w2_wnDsdkCJ1_url_input_box">
                      <div className="selector_input_interaction url_input u-flex u-flex-align--center" id="__w2_wnDsdkCJ1_url_input">
                          ...
                          <input className="input u-flex-auto" type="url" autofocus="True" defaultValue formNoValidate="formnovalidate" placeholder="Enter a link" data-group="js-editable" w2cid="wnDsdkCJ1" id="__w2_wnDsdkCJ1_share_link_url" />
                      </div>
                    </div>
                    <div className="fake_preview hidden" id="__w2_wnDsdkCJ1_fake_preview">
                      <div className="close_wrapper u-flex u-flex-row-reverse">
                          <div className="close_preview" id="__w2_wnDsdkCJ1_close_preview">
                            <div className="x" /></div>
                          </div>
                          <div id="__w2_wnDsdkCJ1_link_preview" /></div>
                          <div id="__w2_wnDsdkCJ1_duplicate_tribe_share" /></div>
                      </div>
                      <div className="modal_footer" id="__w2_wnDsdkCJ1_modal_footer">
                          <div className="modal_actions">
                            <span className="text_links">
                            <Link className="modal_cancel modal_action" id="__w2_wnDsdkCJ1_cancel" onClick = {this.closeModal}>
                            Cancel</Link><span id="__w2_wnDsdkCJ1_submit_question_anon" /></span><span id="__w2_wnDsdkCJ1_submit_question">
                            <button className="submit_button modal_action" href="#" onClick = {this.onSubmit} id="__w2_wnDsdkCJ1_submit">Add Question</button></span><span className="hidden" id="__w2_wnDsdkCJ1_submit_link_footer"><a className="submit_button modal_action" href="#" id="__w2_wnDsdkCJ1_submit_link">Share Link</a></span>
                          </div>
                      </div>
                    </div>
                </div>
...
<div className="modal_header">
   <div className="modal_close" id="__w2_wbuTulbL2_close_button">
      <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only" href="#" role="button" aria-label="Close" id="__w2_wbuTulbL4_button">
   ...
   <div className="modal_title" id="__w2_wbuTulbL2_modal_title">
      <a className="modal_back_button" id="__w2_wbuTulbL2_back_button" />
         New Message
   </div>
</div>
...
<div className="selector_results_container hidden" id="__w2_wbuTulbL3_results_container" style={{overflowY: 'auto', height: 'auto'}}>
<div className="selector_results_container_inner hidden" id="__w2_wbuTulbL3_results" />
