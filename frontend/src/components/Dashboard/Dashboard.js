   ...
   <div>
      <div className="story_title_container">
         <div className="pass_color_to_child_links">
            <div id="whIqsbBW40">
               <a className="question_link" href="/What-is-the-square-root-of-40-41" target="_top" action_mousedown="QuestionLinkClickthrough" id="__w2_whIqsbBW41_link">
               <span className="ui_content_title ui_content_title--default ui_content_title--medium">
                  <span className="ui_qtext_rendered_qtext">sadfasfd</span>
               ...
               <span id="wLjahHEI15">
                  <a className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon" href="#" role="button" action_click="QuestionFollow" action_target="{&quot;qid&quot;: 46052564, &quot;type&quot;: &quot;question&quot;}" id="__w2_wLjahHEI27_button">
                     <div className="ui_button_inner" id="__w2_wLjahHEI27_inner">
                        ...
                        <div className="ui_button_label_count_wrapper"><span className="ui_button_label" id="__w2_wLjahHEI27_label">Follow</span><span className="ui_button_count" aria-hidden="true" id="__w2_wLjahHEI27_count_wrapper"><span className="bullet"> · </span><span className="ui_button_count_inner" id="__w2_wLjahHEI27_count">15</span></span></div>
                     </div>
                  </a>
               </span>
            </div>
