...
<textarea className="selector_input text" type="text" rows={1} title="Start your question with &quot;What&quot;, &quot;How&quot;, &quot;Why&quot;, etc." data-group="js-editable" placeholder="Start your question with &quot;What&quot;, &quot;How&quot;, &quot;Why&quot;, etc." w2cid="wnDsdkCJ5" id="__w2_wnDsdkCJ5_input" style={{overflow: 'hidden', overflowWrap: 'break-word', height: '31px'}} defaultValue={""} />
         ...
         <div className="QuestionSourceEdit">
            <div className="source_editor" id="__w2_wnDsdkCJ7_toolbar">
               <div className="bar bar_link_state u-flex u-flex-align--center">
                  ...
                  <input className="u-flex-auto" type="url" defaultValue formNoValidate="formnovalidate" placeholder="Optional: include a link that gives context" data-group="js-editable" w2cid="wnDsdkCJ7" id="__w2_wnDsdkCJ7_link_input" />
               </div>
            </div>
         </div>
      </div>
      ...
      <div className="fake_preview hidden" id="__w2_wnDsdkCJ1_fake_preview">
         ...
         <div className="modal_footer" id="__w2_wnDsdkCJ1_modal_footer">
            <div className="modal_actions">
               ...
               Cancel</Link><span id="__w2_wnDsdkCJ1_submit_question_anon" /></span><span id="__w2_wnDsdkCJ1_submit_question"><a className="submit_button modal_action" href="#" id="__w2_wnDsdkCJ1_submit">Add Question</a></span><span className="hidden" id="__w2_wnDsdkCJ1_submit_link_footer"><a className="submit_button modal_action" href="#" id="__w2_wnDsdkCJ1_submit_link">Share Link</a></span>
            </div>
         </div>
      </div>
   </div>
