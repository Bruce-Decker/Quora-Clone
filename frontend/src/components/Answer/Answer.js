...
class EditAnswer extends Component {
  ...
  addHyperlink = e => {
    console.log("in add hyperlink", this.state.hyperlink);
                    ...
                    <div className="question_main_col">
                      ...
                      <div id="wiZEgLa412">
                        <div className="QuestionPageAnswerHeader">
                          <div className="answer_count">Answer</div>
                        </div>
                      </div>
                      <div id="wiZEgLa41">
                        <div
