    ...
    return (
      <div className="web_page logged_out lang_en q_ltr logged_out_page_big_signup">
        ...
        <div className="ContentWrapper">
          <div id="__w2_wTICtECy7_content">
            ...
            <div className="BaseSignupForm HomePageSignupForm continue_with_text">
              ...
              <h2 className="NetworkLogoTagline tagline">
              ...
              <div className="container" id="__w2_wTICtECy8_actionable">
                <div className="content_inner">
                  <div className="signup_login">
                    <div className="signup">
                      <div
                        id="__w2_wTICtECy8_initial_signup_column"
                        className="hidden"
                      >
                        <div className="connect_buttons_row">
                          <div>
                            <span
                              ...
                              data-clog-metadata='{"action_log_target": {"type": 43, "hash": "googleConnectButton|911sfjyAdgAMUheK3uC2MA==_1554599139682013"}}'
                              data-clog-event-type="ActionLogImpression"
                              id="__w2_wTICtECy14_actionable"
                              data-clog-processed={1}
                            >
                              <a
                                className="google_button submit_button"
                                href="https://www.quora.com/#"
                                tabIndex={5}
                                action_mousedown="SignupGoogleClick"
                                action_stop_propagation="True"
                                id="__w2_wTICtECy14_google_connect_button"
                              >
                                <span className="google_button_text">
                          ...
                          <div>
                            <span
                              data-clog-trigger="impression"
                              data-clog-metadata='{"action_log_target": {"type": 43, "hash": "facebookConnectButton|911sfjyAdgAMUheK3uC2MA==_1554599139682013"}}'
                              data-clog-event-type="ActionLogImpression"
                              id="__w2_wTICtECy15_actionable"
                              data-clog-processed={1}
                            >
                              <a
                                className="facebook_button submit_button"
                                href="https://www.quora.com/#"
                                tabIndex={6}
                                action_mousedown="SignupFacebookClick"
                                action_stop_propagation="True"
                                id="__w2_wTICtECy15_facebook_connect_button"
                              >
                                <span className="facebook_button_text">
                        ...
                        <div id="__w2_wTICtECy8_connect_explanation">
                          <a
                            className="signup_email_link"
                            href="https://www.quora.com/#"
                            tabIndex={8}
                            id="__w2_wTICtECy8_continue_with_email"
                          >
                            Continue With Email
                          </a>
                      ...
                      <div className id="__w2_wTICtECy8_toggled_signup_column">
                        ...
                        <form
                          ...
                          id="__w2_wTICtECy8_home_page_email_signup_form"
                        >
                          <div className="w2_5">
                            <div className="row">
                              <div className="EmailSignupForm">
                                <div
                                  className="stacked_form e_col p1"
                                  id="__w2_wTICtECy12_email_signup_form"
                                >
                                  <div className="first_last_group">
                                    <div className="form_row half">
                                      ...
                                      <div id="__w2_wTICtECy23_validator">
                                        <div
                                          className="hidden invalid input_validation_error_text"
                                          id="__w2_wTICtECy23_invalid_message"
                                        />
                                    ...
                                    <div className="form_row half last_name">
                                      ...
                                      <div id="__w2_wTICtECy24_validator">
                                        <div
                                          className="hidden invalid input_validation_error_text"
                                          id="__w2_wTICtECy24_invalid_message"
                                        />
                                        <span className="hidden input_valid valid input_status" />
                                        <span className="hidden input_invalid invalid input_status" />
                                        <div className="hidden">
                                  ...
                                  <div className="form_row">
                                    ...
                                    <div id="__w2_wTICtECy25_validator">
                                      <div
                                        className="hidden invalid input_validation_error_text"
                                        id="__w2_wTICtECy25_invalid_message"
                                      />
                                      <span className="hidden input_valid valid input_status" />
                                      <span className="hidden input_invalid invalid input_status" />
                                  ...
                                  <div className="form_row">
                                    ...
                                    <div id="__w2_wTICtECy26_validator">
                                      <div
                                        className="hidden invalid input_validation_error_text"
                                        id="__w2_wTICtECy26_invalid_message"
                                      />
                                      <span className="hidden input_valid valid input_status" />
                                      <span className="hidden input_invalid invalid input_status" />
                                      <div className="hidden">Checking...</div>
                                  ...
                                  <div className="form_row">
                                    <div className="captcha_container">
                                      <div className="CaptchaInput">
                                        <div
                                          className="hidden"
                                          id="__w2_wTICtECy28_captcha_loading"
                                        >
                                        ...
                                        <div id="__w2_wTICtECy28_captcha_area">
                                          <div id="__w2_wTICtECy28_captcha">
                                            ...
                                            >
                                              <div>
                                                <iframe
                                                  src="./Quora - A place to share knowledge and better understand the world_files/anchor.html"
                                                  width={304}
                                                  height={78}
                                                  role="presentation"
                                                  name="a-5uavf5ndssl0"
                              ...
                              <div className="row small">
                                <span className="light_gray TosDisclaimer">
                                  ...
                                  have read and agree to Quora's{" "}
                                  <a
                                    className="tos_link"
                                    href="https://www.quora.com/about/tos"
                                    nav_style="modal_present"
                          ...
                          <div
                            className="hidden input_validation_error_text"
                            id="__w2_wTICtECy8_email_password_leak_error"
                          />
                          <div className="row">
                            <div
                              className="form_buttons"
                              id="__w2_wTICtECy8_create_account"
                            >
                              <span className="light">
                                <Link
                                  to="/"
                                  className="cancel"
                                  id="__w2_wTICtECy8_cancel"
                                >
                                  Cancel
                                </Link>

                                <input
                                  className="submit_button ignore_interaction"
                                  type="submit"
                                  defaultValue="Login"
                                  tabIndex={4}
                                  data-group="js-editable"
                                  w2cid="wTICtECy18"
                                  id="__w2_wTICtECy18_submit_button"
                                />
                              </span>
                            </div>
                          </div>
                    ...
                    <div className="login">
                      <div id="wTICtECy17">
                        <div
                          className="InlineLogin LoggedOutHomeLogin"
                          id="__w2_wTICtECy18_logged_out_header_login"
                        >
                          <div className="regular_login">
                            <form
                              className="inline_login_form"
                              id="__w2_wTICtECy18_login_form"
                            >
                              <div className="title login_title">Login</div>
                              <div className="form_inputs">
                                <div className="form_column">
                                  <input
                                    className="text header_login_text_box ignore_interaction"
                                    type="text"
                                    name="email"
                                    tabIndex={1}
                                    data-group="js-editable"
                                ...
                                <div className="form_column">
                                  <span className="login_options">
                                    <a
                                      ...
                                      href="https://www.quora.com/#"
                                      id="__w2_wTICtECy18_forgot_password_link"
                                    >
                                      Forgot Password?
                                    </a>
                                  </span>
                                ...
                                <div id="__w2_wTICtECy18_errors">
                                  ...
                                  >
                                    ...
                                    <a
                                      href="https://www.quora.com/#"
                                      id="__w2_wTICtECy18_resend_confirmation"
                                    >
                                  ...
                                  <div
                                    className="hidden input_validation_error_text"
                                    id="__w2_wTICtECy18_email_not_found_error"
                                  >
                                    No account found for this email. Retry, or{" "}
                                    <a
                                      href="https://www.quora.com/"
                                      id="__w2_wTICtECy18_email_not_found_signup_link"
                                    >
                                      Sign up for Quora.
                                    </a>
                                  </div>
                                  <div
                                    className="hidden input_validation_error_text"
                                    id="__w2_wTICtECy18_incorrect_password_error"
                                  >
                                    Incorrect password.{" "}
                                    <a
                                      href="https://www.quora.com/#"
                                      id="__w2_wTICtECy18_reset_password_link"
                                    >
                                      Reset Password
                                    </a>
                                  </div>
                ...
                <div
                  className="HomepageSignupNetworkRedirectLink"
                  id="__w2_wTICtECy20_link"
                >
                  New:{" "}
                  <a
                    className="new_network"
                    href="https://nl.quora.com/"
                    data-nid={13}
                  >
                    Dutch
                  </a>
        ...
        <div className="__live_spinner hidden" id="__w2_wf4F12ZE14_loading">
          <div
            className="__live_spinner_indicator"
            id="__w2_wf4F12ZE14_spinner"
          />
        </div>
          ...
          >
            ...
            <div>
              <iframe
                ...
                tabIndex={-1}
                src="./Quora - A place to share knowledge and better understand the world_files/d_vbiawPdxB.html"
                style={{ border: "none" }}
              />
            </div>
          </div>
        ...
        <iframe
          ...
          aria-hidden="true"
          frame-border={0}
          src="./Quora - A place to share knowledge and better understand the world_files/iframe.html"
          style={{
            position: "absolute",
            width: "1px",
            height: "1px",
        ...
        >
          ...
          <div style={{ zIndex: 2000000000, position: "relative" }}>
            <iframe
              ...
              src="./Quora - A place to share knowledge and better understand the world_files/bframe.html"
              name="c-5uavf5ndssl0"
              frameBorder={0}
              scrolling="no"
              sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"
