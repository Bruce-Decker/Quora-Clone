...
onTopicBlur = () => {
  ...
  profilecredentialsHandler = e => {
    this.setState({
      profilecredentials: e.target.value
    });
  };
   ...
   submitEmploymentDetails() {
      ...
      let data = {
         ...
         career_information: this.state.career,
         description: this.state.description,
         profile_credential: this.state.profilecredentials,
         email: this.props.match.params.email
      }
      this.closeModal();
      axios.post(rooturl + "/profile/createProfile", data).then(response => {
                ...
                <div className="profile_wrapper">
                      ...
                      <div className="ProfilePhoto">
                        <div id="wYSVVNEt49">
                          ...
                          >
                            ...
                            <div
                              className="x_photo hidden"
                              id="__w2_wYSVVNEt50_x_photo"
                            >
                              <a
                                className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_small u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only"
                                href="#"
                                role="button"
                                aria-label="Remove this photo"
                                id="__w2_wYSVVNEt61_button"
                              >
                                <div
                                  className="ui_button_inner"
                                  id="__w2_wYSVVNEt61_inner"
                                >
                            ...
                            <div
                              className="edit_profile_photo hidden"
                              id="__w2_wYSVVNEt50_edit"
                            >
                              <span id="__w2_wYSVVNEt62_open_edit_photo">
                                <a
                                  ...
                                  href="#"
                                  role="button"
                                  id="__w2_wYSVVNEt64_button"
                                >
                                  <div
                                    className="ui_button_inner"
                                    id="__w2_wYSVVNEt64_inner"
                                  >
                                    <div className="ui_button_label_count_wrapper">
                                      <span
                                        className="ui_button_label"
                                        id="__w2_wYSVVNEt64_label"
                                      >
                                        Edit Photo
                                      </span>
                                    </div>
                    ...
                    <div className="header_content">
                        ...
                        <div className="ProfileNameAndSig">
                          <div id="wYSVVNEt51">
                            <div className="NGProfileNameEditor">
                              ...
                              <div
                                className="hidden"
                                id="__w2_wYSVVNEt52_editor"
                              >
                                <input
                                  type="text"
                                  defaultValue="Bruce Decker"
                                  data-group="js-editable"
                                  placeholder="Your Full Name"
                                  w2cid="wYSVVNEt52"
                                  id="__w2_wYSVVNEt52_name"
                                />
                                <a
                        ...
                        <div className="ProfileDescriptionPreviewSection">
                          <div id="wYSVVNEt69">
                            <div className="ProfileDescription">
                              <div
                                className="UserDescriptionInlineEditor InlineEditor inline_editor_content"
                                id="__w2_wYSVVNEt110_inline_editor_content"
                              >
                              ...
                              <div
                                ...
                                id="__w2_wYSVVNEt110_inline_editor_form"
                              >
                                <div className="inline_editor_form">
                                  <div
                                    className="editor_wrapper"
                                    id="__w2_wYSVVNEt112_editor_outer"
                                  >
                                    <div
                                      className="Editor ProfileDescription edit_latex web"
                                      id="__w2_wYSVVNEt112_editor"
                                    >
                                      <div
                                        data-group="js-editable"
                                        w2cid="wYSVVNEt112"
                                        id="__w2_wYSVVNEt112_doc"
                                      >
                                        <div
                                          className="doc empty"
                                      ...
                                      >
                                        <div
                                          className="scroller"
                                          id="__w2_wYSVVNEt115_scroller"
                                          style={{ top: "-100%" }}
                                        >
                                          <div
                                            className="bar bar_link_state"
                                            id="__w2_wYSVVNEt115_bar0"
                                          >
                                          ...
                                          <div
                                            ...
                                            id="__w2_wYSVVNEt115_bar1"
                                          >
                                            <div className="left u-flex-auto u-margin-right--sm">
                                              <div
                                                className="modifier"
                                                tooltip="Bold"
                                                id="__w2_wYSVVNEt115_bold"
                                              >
                                              ...
                                              <div
                                                className="modifier"
                                                tooltip="Numbers"
                                                id="__w2_wYSVVNEt115_ordered_list"
                                              >
                                                <span className="default_icon">
                                                  <span
                                                    className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default"
                                              ...
                                              <div
                                                className="modifier"
                                                tooltip="Bullets"
                                                id="__w2_wYSVVNEt115_unordered_list"
                                              >
                                                <span className="default_icon">
                                                  <span
                                                    className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default"
                                            ...
                                            <div className="right">
                                              ...
                                              <div
                                                className="modifier"
                                                tooltip="Show more"
                                                id="__w2_wYSVVNEt115_overflow_show"
                                              >
                                                <span className="default_icon">
                                                  <span
                                                    className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default"
                                          ...
                                          <div
                                            ...
                                            id="__w2_wYSVVNEt115_bar2"
                                          >
                                            <div className="left u-flex-auto u-margin-right--sm">
                                              <div
                                                className="modifier"
                                                tooltip="Mention user, topic or question"
                                                id="__w2_wYSVVNEt115_mention"
                                              >
                                                <span className="default_icon">
                                                  <span
                                                    className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default"
                                            ...
                                            <div className="right">
                                              ...
                                              <div
                                                className="modifier"
                                                tooltip="Show less"
                                                id="__w2_wYSVVNEt115_overflow_hide"
                                              >
                                                <span className="default_icon">
                                                  <span
                                                    className="ui_icon ui_icon_color--gray ui_icon_size--regular ui_icon_outline--default"
                                        ...
                                        <div
                                          className="hidden"
                                          id="__w2_wYSVVNEt115_storage"
                                        >
                                          <div
                                            className="u-inline-flex"
                                            id="__w2_wYSVVNEt115_link_input_icon"
                                          >
                                            <span
                                          ...
                                          <input
                                            ...
                                            w2cid="wYSVVNEt115"
                                            id="__w2_wYSVVNEt115_link_input"
                                          />
                                          <div
                                            className="cite"
                                            id="__w2_wYSVVNEt115_cite"
                                          >
                                            <input
                                              type="checkbox"
                                              formNoValidate="formnovalidate"
                                              data-group="js-editable"
                                              w2cid="wYSVVNEt115"
                                              id="__w2_wYSVVNEt115_is_citation"
                                            />
                                            <label htmlFor="__w2_wYSVVNEt115_is_citation">
                                              Footnote
                                            </label>
                                          </div>
                                          <button
                                            type="button"
                                            id="__w2_wYSVVNEt115_link_save"
                                          >
                                            Add
                                          </button>
                                          <div
                                      ...
                                      <input
                                        ...
                                        data-group="js-editable"
                                        w2cid="wYSVVNEt112"
                                        id="__w2_wYSVVNEt112_file"
                                      />
                                      <div
                                        className="drop_zone hidden"
                                        id="__w2_wYSVVNEt112_drop_zone"
                                      />
                                      <div
                                        className="hidden"
                                        id="__w2_wYSVVNEt112_link_selector_wrapper"
                                      >
                                        <div
                                          className="Selector LinkSelector"
                                          tabIndex={-1}
                                          id="__w2_wYSVVNEt116_wrapper"
                                        >
                                          <div className="link_selector_input">
                                            <div className="selector_input_interaction">
                                              <div
                                                className="CharacterCounter fade_out"
                                                id="__w2_wYSVVNEt152_counter_wrapper"
                                              >
                                                <div
                                                  className="counter"
                                                  id="__w2_wYSVVNEt152_counter"
                                                >
                                                  250
                                                </div>
                                              </div>
                                              <input
                                                ...
                                                placeholder="Search"
                                                w2cid="wYSVVNEt116"
                                                id="__w2_wYSVVNEt116_input"
                                              />
                                              <div
                                                className="selector_spinner hidden"
                                                id="__w2_wYSVVNEt116_spinner"
                                              >
                                          ...
                                          <div
                                            ...
                                            id="__w2_wYSVVNEt116_results_container"
                                          >
                                            <div
                                              className="selector_results_container_inner hidden"
                                              id="__w2_wYSVVNEt116_results"
                                            />
                                            <div id="__w2_wYSVVNEt116_empty_input_prompt" />
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  >
                                    <div className="inline_editor_buttons">
                                      ...
                                      <a
                                        ...
                                        id="__w2_wYSVVNEt110_inline_editor_submit"
                                      >
                                        Update
                                      </a>
                                    </div>
                      ...
                      <div id="wYSVVNEt28">
                        <div
                          ...
                          id="__w2_wYSVVNEt29_action_bar"
                        >
                          <div className="action_bar_inner u-flex">
                            <div className="ItemComponent FollowPrimaryActionItem primary_item u-relative">
                              <span id="wYSVVNEt157">
                                <a
                                  className="ui_button disabled u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--blue ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon"
                                  href="#"
                                  role="button"
                                  action_target='{"type": "user", "uid": 782622776}'
                                  id="__w2_wYSVVNEt159_button"
                                >
                                  <div
                                    className="ui_button_inner"
                                    id="__w2_wYSVVNEt159_inner"
                                  >
                                    <div className="ui_button_label_count_wrapper">
                      ...
                      <div id="__w2_wYSVVNEt30_suggested_section" />
                    </div>
                  </div>

                  <div
                    className="layout_3col_left"
                    id="__w2_wIYwSz7m17_left_col"
                  >
                    <div id="__w2_wIYwSz7m17_left_col_inner">
                      <div
                        className="ProfileNavList NavList EditableList"
                        id="__w2_wIYwSz7m32_wrapper"
                      >
                        <h3 className="title">
                          <div>Feeds</div>
                        </h3>
                  ...
                  <div className="layout_3col_center">
                    <div id="wYSVVNEt33">
                      <div className="CredentialsProgressBarWrapper">
                        <div id="__w2_wYSVVNEt34_progress_wrapper">
                          <div
                            className="expanded u-zindex--200"
                            id="__w2_wYSVVNEt34_expanded"
                          >
                            <div className="card_inner">
                              <div id="wYSVVNEt91">
                                <div
                                  className="CredentialsProgressBar PartnerProgressBar not_started"
                                  id="__w2_wYSVVNEt92_container"
                                />
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="list_header">
                      <div id="wYSVVNEt35">
                        Profile
                        <span className="UserCombinedHeader switcher">
                          <span className="current_item">Most Recent</span> /{" "}
                          <a href="https://www.quora.com/profile/Bruce-Decker-12?sort=views">
                            All-Time Views
                          </a>
                        </span>
                      </div>
                    ...
                    <div className="profile_feed_wrapper">
                      ...
                      <div id="wYSVVNEt41">
                        <div
                          className="UserCombinedProfileFeed PagedListFoo UserProfileFeed unified"
                          id="__w2_wYSVVNEt42_paged_list"
                        >
                          <div
                            className="paged_list_wrapper"
                            id="__w2_wYSVVNEt42_paged_list_wrapper"
                          >
                              ...
                              {this.state.showList ? (
                                <div>
                                  {this.state.questions.map(question => (
                                    <div
                                      className="AnswerListItem PagedListItem"
                                      data-clog-trigger="impression"
                                      data-clog-metadata='{"object_view": {"view_tracking_key": "a-136667387", "view_tracking_hash": "bb7c85c5e171a9d0b96600e3c087a2b5"}}'
                                      data-clog-event-type="ObjectView"
                                      data-clog-processed={1}
                                    >
                                      <div
                                        className="feedback_wrapper hidden"
                                        id="__w2_wpZ4kBSr3_answer_feedback"
                                      />
                                      <div
                                        className="inline_expand_item feed_item"
                                        id="__w2_wpZ4kBSr3_item"
                                      >
                                        <span id="__w2_wpZ4kBSr11_answer_story">
                                          <span id="__w2_wpZ4kBSr13_answer_story">
                                          ...
                                          <span
                                            className="hidden"
                                            id="__w2_wpZ4kBSr13_question_answer_story_editable"
                                          />
                                        </span>
                                        ...
                                        <div id="__w2_wpZ4kBSr11_action_bar_truncated">
                                          <div id="wpZ4kBSr20">
                                            ...
                                            <div
                                              ...
                                              id="__w2_wpZ4kBSr21_action_bar"
                                            >
                                              <div id="woEJoWe01">
                                                <div className="Metabar AnswerMetabarPrependItem ItemComponent u-relative">
                                                  <div
                                                    className="prepend_item_inner pass_color_to_child_links should_show is_active"
                                                    id="__w2_woEJoWe02_wrapper"
                                                  >
                                                    <div
                                                      className="prepend_item_content u-relative"
                                                      id="__w2_woEJoWe02_content"
                                                    >
                                                      <span
                                                        className="meta_bar_pre_upvote_wrapper"
                                                        id="__w2_woEJoWe02_pre_upvote_text"
                                                      >
                                                        <div id="w2dPWtzQ1" />
                                                      </span>
                                                      <span
                                                        className="meta_bar_post_upvote_wrapper hidden"
                                                        id="__w2_woEJoWe02_post_upvote_text"
                                                      >
                                                        <div id="w2dPWtzQ3">
                                        ...
                                        <div
                                          className="hidden"
                                          id="__w2_wpZ4kBSr11_action_bar_expanded"
                                        >
                                          <div id="wpZ4kBSr22">
                                            <div
                                              style={{
                                            ...
                                            <div
                                              className="icon_action_bar with_metabar"
                                              id="__w2_wpZ4kBSr23_action_bar"
                                            >
                                              <div id="wbcNzjHA1">
                                                <div className="Metabar AnswerMetabarPrependItem ItemComponent u-relative">
                                                  <div
                                                    className="prepend_item_inner pass_color_to_child_links should_show is_active"
                                                    id="__w2_wbcNzjHA2_wrapper"
                                                  >
                                                    <div
                                                      className="prepend_item_content u-relative"
                                                      id="__w2_wbcNzjHA2_content"
                                                    >
                                                      <span
                                                        className="meta_bar_pre_upvote_wrapper"
                                                        id="__w2_wbcNzjHA2_pre_upvote_text"
                                                      >
                                                        <div id="wET07O1N1" />
                                                      </span>
                                                      <span
                                                        className="meta_bar_post_upvote_wrapper hidden"
                                                        id="__w2_wbcNzjHA2_post_upvote_text"
                                                      >
                                                        <div id="wET07O1N3">
                                                          <div className="unstyled_social_bar">
                                                            <div className="photos">
                                              ...
                                              <div className="action_bar_inner u-flex">
                                                <span id="wbcNzjHA3">
                                                  <a
                                                    className="ui_button disabled u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--blue ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon u-tap-highlight--none"
                                                    href="#"
                                                    role="button"
                                                    action_target='{"aid": 136667387, "type": "answer"}'
                                                    id="__w2_w7uQjR091_button"
                                                  >
                                                    <div
                                                      className="ui_button_inner"
                                                      id="__w2_w7uQjR091_inner"
                                                    >
                                                      <div className="ui_button_label_count_wrapper">
                                                        <span
                                                          className="ui_button_label"
                                                          id="__w2_w7uQjR091_label"
                                                        >
                                                          0 Upvotes
                                                        </span>
                                                      </div>
                                                ...
                                                <div className="QuoraShareActionItem ActionItemComponent ItemComponent action_item u-relative">
                                                  <div id="wbcNzjHA9">
                                                    <a
                                                      ...
                                                      href="#"
                                                      role="button"
                                                      id="__w2_wbcNzjHA16_button"
                                                    >
                                                      <div
                                                        className="ui_button_inner"
                                                        id="__w2_wbcNzjHA16_inner"
                                                      >
                                                        <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                                        ...
                                                        <div className="ui_button_label_count_wrapper">
                                                          ...
                                                          <span
                                                            ...
                                                            aria-hidden="true"
                                                            id="__w2_wbcNzjHA16_count_wrapper"
                                                          >
                                                    ...
                                                    <div id="__w2_wbcNzjHA10_quora_share_tooltip" />
                                                  </div>
                                                </div>
                                                <div className="OverflowShareActionItem ActionItemComponent ItemComponent action_item secondary_item u-relative">
                                                  <div id="wbcNzjHA11">
                                                    <div
                                                      ...
                                                      id="__w2_wbcNzjHA12_menu"
                                                    >
                                                      <div
                                                        className="hover_menu_contents"
                                                        id="__w2_wbcNzjHA12_menu_contents"
                                                      >
                                                        {" "}
                                                      </div>
                                                    </div>
                                                    ...
                                                    >
                                                      <a
                                                        ...
                                                        id="__w2_wbcNzjHA15_button"
                                                      >
                                                        <div
                                                          className="ui_button_inner"
                                                          id="__w2_wbcNzjHA15_inner"
                                                        >
                                                          <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                                ...
                                                <div className="overflow action_item overflow_link u-relative u-pointer-events--auto">
                                                  <div
                                                    ...
                                                    id="__w2_wpZ4kBSr23_overflow_link"
                                                  >
                                                    <a
                                                      className="ui_button u-nowrap ui_button--styled ui_button--FlatStyle ui_button--FlatStyle--gray ui_button--size_regular u-inline-block ui_button--non_link ui_button--supports_icon ui_button--has_icon ui_button--icon_only"
                                                      href="#"
                                                      ...
                                                      id="__w2_wbcNzjHA8_button"
                                                    >
                                                      <div
                                                        className="ui_button_inner"
                                                        id="__w2_wbcNzjHA8_inner"
                                                      >
                                                        <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                                ...
                                                <div
                                                  className="hover_menu hidden show_nub fixed_menu_width no_body_attach right_align"
                                                  id="__w2_wpZ4kBSr23_overflow_menu"
                                                >
                                                  <div
                                                    className="hover_menu_contents lazy"
                                                    id="__w2_wpZ4kBSr23_overflow_menu_contents"
                                                  />
                                                </div>
                                              </div>
                                            </div>
                            ...
                            <div className="pagedlist_item" id="wpZ4kBSr4">
                              <div
                                className="AnswerListItem PagedListItem"
                                data-clog-trigger="impression"
                                data-clog-metadata='{"object_view": {"view_tracking_key": "a-136667002", "view_tracking_hash": "46ff26119999c7f1c752374224b086af"}}'
                                data-clog-event-type="ObjectView"
                                data-clog-processed={1}
                              >
                                <div
                                  className="feedback_wrapper hidden"
                                  id="__w2_wpZ4kBSr6_answer_feedback"
                                />
                              </div>
                            </div>
                          </div>
                  ...
                  <div id="wYSVVNEt43">
                    <div className="AboutSection">
                      <h3 className="title">
                        ...
                        <span id="woVa9VIC7">
                          <a
                            className="EditCredentialsModalLink CredentialModalLink"
                            href="#"
                            id="__w2_woVa9VIC8_modal_link"
                          >
                                        ...
                                        <div className="modal_header">
                                          ...
                                          >
                                            <Link
                                              ...
                                              role="button"
                                              aria-label="Close"
                                              id="__w2_wS3v0b3P7_button"
                                              onClick={this.closeModal}
                                            >
                                              <div
                                                className="ui_button_inner"
                                                id="__w2_wS3v0b3P7_inner"
                                              >
                                                <div className="ui_button_icon_wrapper u-relative u-flex-inline">
                                          ...
                                          <div
                                            ...
                                            id="__w2_wS3v0b3P3_modal_title"
                                          >
                                            Edit credentials
                                          </div>
                                          <div
                                            className="modal_subtitle"
                                            id="__w2_wS3v0b3P3_modal_subtitle"
                                          >
                                            Credentials also appear on answers
                                            you write.
                                          </div>
                                        </div>
                                        <div
                                          className="modal_content modal_body"
                                          id="__w2_wS3v0b3P3_content"
                                        >
                                          <div id="wS3v0b3P4">
                                            <a
                                              className="AddCredentialDropdown hidden"
                                              href="#"
                                              id="__w2_wS3v0b3P5_add_link"
                                            >
                                              <div className="u-absolute u-top--0 u-left--0 u-margin-left--md u-margin-top--md">
                                                <span
                                                  className="ui_icon ui_icon_color--blue ui_icon_size--small_medium ui_icon_outline--default"
                                                  aria-hidden="true"
                                                >
                                                  <svg
                                                    width="24px"
                                            ...
                                            <div
                                              className="hidden hover_menu hover_menu_credential show_nub"
                                              id="__w2_wS3v0b3P5_overflow_menu"
                                            >
                                              <div className="hover_menu_contents">
                                                <ul className="menu_list_items unified_menu">
                                                  <li className="menu_list_item">
                                                    <a
                                                      className="js_category_link u-flex u-flex-align--center"
                                                      data-category={1}
                                                    >
                                                      <div className="u-margin-right--sm u-flex-inline">
                                                        <span
                                                          className="ui_icon ui_icon_color--gray ui_icon_size--small_medium ui_icon_outline--default"
                                                          aria-hidden="true"
                                                        >
                                                          <svg
                                                            width="24px"
                                            ...
                                            <div id="wS3v0b3P14">
                                              <div
                                                className="credential_list_item is_add_form"
                                                id="__w2_wS3v0b3P15_wrapper_1"
                                              >
                                                <div className="edit_wrapper">
                                                  ...
                                                  <div id="wS3v0b3P17">
                                                    <form
                                                      className="Form AddCredentialsFormWork AddCredentialsForm"
                                                      method="post"
                                                      id="__w2_wS3v0b3P18_form"
                                                    >
                                                      <div className="FormField FormFieldInput with_label with_character_counter">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P32_error_tooltip"
                                                        >
                                                        ...
                                                        <label
                                                          ...
                                                          htmlFor="__w2_wS3v0b3P32_position"
                                                          id="__w2_wS3v0b3P32_label"
                                                        >
                                                          First Name
                                                        </label>
                                                        <input
                                                        ...
                                                        <div
                                                          className="CharacterCounter fade_out"
                                                          id="__w2_wS3v0b3P37_counter_wrapper"
                                                        >
                                                          <div
                                                            className="counter"
                                                            id="__w2_wS3v0b3P37_counter"
                                                          >
                                                            50
                                                          </div>
                                                        </div>
                                                      ...
                                                      <div className="FormField FormFieldInput with_label with_character_counter">
                                                        ...
                                                        <input
                                                          ...
                                                          w2cid="wS3v0b3P32"
                                                          id="__w2_wS3v0b3P32_position"
                                                          onChange = {this.profilecredentialsHandler}
                                                        />
                                                        <div
                                                          className="CharacterCounter fade_out"
                                                          id="__w2_wS3v0b3P37_counter_wrapper"
                                                      ...
                                                      <div className="form_action_bar clearfix">
                                                        <input
                                                          className="submit_button form_submit_button"
                                                          type="submit"
                                                          defaultValue="Save"
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P18"
                                                          id="__w2_wS3v0b3P18_submit"
                                                          onClick={
                                                            this
                                                              .submitEmploymentDetails
                                                          }
                                              ...
                                              <div
                                                className="credential_list_item is_add_form hidden"
                                                id="__w2_wS3v0b3P15_wrapper_2"
                                              >
                                                <div className="edit_wrapper">
                                                  <div className="u-absolute u-top--0 u-left--0 u-margin-left--md u-margin-top--md">
                                                    <span
                                                  ...
                                                  <div id="wS3v0b3P20">
                                                    <form
                                                      className="AddCredentialsForm Form AddCredentialsFormSchool"
                                                      method="post"
                                                      id="__w2_wS3v0b3P21_form"
                                                    >
                                                      <div className="FormField FormFieldTopicSelector with_label">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P42_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P42_school"
                                                          id="__w2_wS3v0b3P42_label"
                                                        >
                                                          School
                                                        </label>
                                                        <span id="__w2_wS3v0b3P42_selector">
                                                          <div
                                                            className="Selector TopicSelector TopicSelectorForFormField AddTopicSelector"
                                                            tabIndex={-1}
                                                            id="__w2_wS3v0b3P47_wrapper"
                                                          >
                                                            <div className="selector_input_interaction">
                                                              <input
                                                                className="selector_input text"
                                                                ...
                                                                w2cid="wS3v0b3P47"
                                                                id="__w2_wS3v0b3P47_input"
                                                              />
                                                              <div
                                                                className="selector_spinner hidden"
                                                                id="__w2_wS3v0b3P47_spinner"
                                                              >
                                                                <div className="LoadingDots tiny">
                                                                  <div className="dot first" />
                                                                  <div className="dot second" />
                                                            ...
                                                            <div
                                                              ...
                                                              id="__w2_wS3v0b3P47_results_container"
                                                            >
                                                              <div
                                                                className="selector_results_container_inner hidden"
                                                                id="__w2_wS3v0b3P47_results"
                                                              />
                                                              <div id="__w2_wS3v0b3P47_empty_input_prompt" />
                                                            </div>
                                                          </div>
                                                        </span>
                                                        <div
                                                          className="topic_selection hidden"
                                                          id="__w2_wS3v0b3P42_school"
                                                        />
                                                        <input
                                                          className="hidden"
                                                          type="number"
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P42"
                                                          id="__w2_wS3v0b3P42_value"
                                                        />
                                                        <div
                                                          className="remove_link hidden"
                                                          id="__w2_wS3v0b3P42_remove_topic"
                                                        >
                                                          <span
                                                            className="ui_icon ui_icon_color--gray ui_icon_size--xsmall ui_icon_outline--default"
                                                            aria-hidden="true"
                                                          >
                                                            <svg
                                                              width="24px"
                                                      ...
                                                      <div className="FormField FormFieldTopicSelector with_label">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P43_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P43_concentration"
                                                          id="__w2_wS3v0b3P43_label"
                                                        >
                                                          Concentration
                                                        </label>
                                                          ...
                                                          >
                                                            <div className="selector_input_interaction">
                                                              <input
                                                                ...
                                                                placeholder="Theater"
                                                                w2cid="wS3v0b3P51"
                                                                id="__w2_wS3v0b3P51_input"
                                                              />
                                                              <div
                                                                className="selector_spinner hidden"
                                                                id="__w2_wS3v0b3P51_spinner"
                                                              >
                                                                <div className="LoadingDots tiny">
                                                                  <div className="dot first" />
                                                                  <div className="dot second" />
                                                            ...
                                                            <div
                                                              className="selector_results_container is_inline hidden"
                                                              id="__w2_wS3v0b3P51_results_container"
                                                            >
                                                              <div
                                                                className="selector_results_container_inner hidden"
                                                                id="__w2_wS3v0b3P51_results"
                                                              />
                                                              <div id="__w2_wS3v0b3P51_empty_input_prompt" />
                                                            </div>
                                                          </div>
                                                        </span>
                                                        <div
                                                          className="topic_selection hidden"
                                                          id="__w2_wS3v0b3P43_concentration"
                                                        />
                                                        <input
                                                          className="hidden"
                                                          type="number"
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P43"
                                                          id="__w2_wS3v0b3P43_value"
                                                        />
                                                        <div
                                                          className="remove_link hidden"
                                                          id="__w2_wS3v0b3P43_remove_topic"
                                                        >
                                                          <span
                                                            className="ui_icon ui_icon_color--gray ui_icon_size--xsmall ui_icon_outline--default"
                                                            aria-hidden="true"
                                                      ...
                                                      <div className="FormField FormFieldTopicSelector with_label">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P44_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P44_second_concentration"
                                                          id="__w2_wS3v0b3P44_label"
                                                        >
                                                          Secondary
                                                          Concentration
                                                        </label>
                                                          ...
                                                          >
                                                            <div className="selector_input_interaction">
                                                              <input
                                                                ...
                                                                placeholder="Dance"
                                                                w2cid="wS3v0b3P55"
                                                                id="__w2_wS3v0b3P55_input"
                                                              />
                                                              <div
                                                                className="selector_spinner hidden"
                                                                id="__w2_wS3v0b3P55_spinner"
                                                              >
                                                                <div className="LoadingDots tiny">
                                                                  <div className="dot first" />
                                                                  <div className="dot second" />
                                                            ...
                                                            <div
                                                              className="selector_results_container is_inline hidden"
                                                              id="__w2_wS3v0b3P55_results_container"
                                                            >
                                                              <div
                                                                className="selector_results_container_inner hidden"
                                                                id="__w2_wS3v0b3P55_results"
                                                              />
                                                              <div id="__w2_wS3v0b3P55_empty_input_prompt" />
                                                            </div>
                                                          </div>
                                                        </span>
                                                        <div
                                                          className="topic_selection hidden"
                                                          id="__w2_wS3v0b3P44_second_concentration"
                                                        />
                                                        <input
                                                          className="hidden"
                                                          type="number"
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P44"
                                                          id="__w2_wS3v0b3P44_value"
                                                        />
                                                        <div
                                                          className="remove_link hidden"
                                                          id="__w2_wS3v0b3P44_remove_topic"
                                                        >
                                                          <span
                                                            className="ui_icon ui_icon_color--gray ui_icon_size--xsmall ui_icon_outline--default"
                                                            aria-hidden="true"
                                                      ...
                                                      <div className="FormField FormFieldInput with_label is_degree with_character_counter">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P45_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P45_degree"
                                                          id="__w2_wS3v0b3P45_label"
                                                        >
                                                          Degree Type
                                                        </label>
                                                        <input
                                                          ...
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P45"
                                                          id="__w2_wS3v0b3P45_degree"
                                                        />
                                                        <div
                                                          className="CharacterCounter fade_out"
                                                          id="__w2_wS3v0b3P59_counter_wrapper"
                                                        >
                                                          <div
                                                            className="counter"
                                                            id="__w2_wS3v0b3P59_counter"
                                                          >
                                                            25
                                                          </div>
                                                        </div>
                                                      </div>
                                                      <div className="FormField FormFieldSelect with_label">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P46_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P46_end_year"
                                                          id="__w2_wS3v0b3P46_label"
                                                        >
                                                          Graduation Year
                                                        </label>
                                                        <select
                                              ...
                                              >
                                                <div className="edit_wrapper">
                                                  ...
                                                  <div id="wS3v0b3P23">
                                                    <form
                                                      className="Form AddCredentialsFormLocation AddCredentialsForm"
                                                      method="post"
                                                      id="__w2_wS3v0b3P24_form"
                                                    >
                                                      <div className="FormField FormFieldTopicSelector with_label">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P76_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P76_location"
                                                          id="__w2_wS3v0b3P76_label"
                                                        >
                                                          Location (required)
                                                        </label>
                                                          ...
                                                          >
                                                            <div className="selector_input_interaction">
                                                              <input
                                                                ...
                                                                w2cid="wS3v0b3P80"
                                                                id="__w2_wS3v0b3P80_input"
                                                              />
                                                              <div
                                                                className="selector_spinner hidden"
                                                                id="__w2_wS3v0b3P80_spinner"
                                                              >
                                                                <div className="LoadingDots tiny">
                                                                  <div className="dot first" />
                                                                  <div className="dot second" />
                                                            ...
                                                            <div
                                                              className="selector_results_container is_inline hidden"
                                                              id="__w2_wS3v0b3P80_results_container"
                                                            >
                                                              <div
                                                                className="selector_results_container_inner hidden"
                                                                id="__w2_wS3v0b3P80_results"
                                                              />
                                                              <div id="__w2_wS3v0b3P80_empty_input_prompt" />
                                                            </div>
                                                          </div>
                                                        </span>
                                                        <div
                                                          className="topic_selection hidden"
                                                          id="__w2_wS3v0b3P76_location"
                                                        />
                                                        <input
                                                          className="hidden"
                                                          type="number"
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P76"
                                                          id="__w2_wS3v0b3P76_value"
                                                        />
                                                        <div
                                                          className="remove_link hidden"
                                                          id="__w2_wS3v0b3P76_remove_topic"
                                                        >
                                                          <span
                                                            className="ui_icon ui_icon_color--gray ui_icon_size--xsmall ui_icon_outline--default"
                                                            aria-hidden="true"
                                                      ...
                                                      <div className="FormField FormFieldSelect with_label">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P77_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P77_start_year"
                                                          id="__w2_wS3v0b3P77_label"
                                                        >
                                                          Start Year
                                                        </label>
                                                        <select
                                                      ...
                                                      <div className="FormField FormFieldSelect with_label">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P78_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P78_end_year"
                                                          id="__w2_wS3v0b3P78_label"
                                                        >
                                                          End Year
                                                        </label>
                                                        <select
                                                      ...
                                                      <div
                                                        className="FormFieldButton FormFieldCheckbox FormField with_label"
                                                        id="__w2_wS3v0b3P79_wrapper"
                                                      >
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P79_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P79_current"
                                                          id="__w2_wS3v0b3P79_label"
                                                        >
                                                ...
                                                <div className="edit_wrapper">
                                                  ...
                                                  <div className="u-padding-top--sm u-padding-bottom--xs">
                                                    <div className="u-bg--gray-ultralight u-border-radius--4 u-border-all u-font-size--13 u-padding-all--md">
                                                      <p className="u-margin-bottom--sm u-font-weight--medium">
                                                        Good credentials are:{" "}
                                                      </p>
                                                  ...
                                                  <div id="wS3v0b3P27">
                                                    <form
                                                      className="AddCredentialsFormLifeExperience Form AddCredentialsForm"
                                                      method="post"
                                                      id="__w2_wS3v0b3P28_form"
                                                    >
                                                      <div className="FormField FormFieldTopicSelector with_label">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P63_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P63_topic"
                                                          id="__w2_wS3v0b3P63_label"
                                                        >
                                                          Select a topic
                                                        </label>
                                                          ...
                                                          >
                                                            <div className="selector_input_interaction">
                                                              <input
                                                                ...
                                                                data-lpignore="true"
                                                                data-group="js-editable"
                                                                placeholder="Visiting and Travel"
                                                                w2cid="wS3v0b3P66"
                                                                id="__w2_wS3v0b3P66_input"
                                                              />
                                                              <div
                                                                className="selector_spinner hidden"
                                                                id="__w2_wS3v0b3P66_spinner"
                                                              >
                                                                <div className="LoadingDots tiny">
                                                                  <div className="dot first" />
                                                                  <div className="dot second" />
                                                            ...
                                                            <div
                                                              className="selector_results_container is_inline hidden"
                                                              id="__w2_wS3v0b3P66_results_container"
                                                            >
                                                              <div
                                                                className="selector_results_container_inner hidden"
                                                                id="__w2_wS3v0b3P66_results"
                                                              />
                                                              <div id="__w2_wS3v0b3P66_empty_input_prompt" />
                                                            </div>
                                                          </div>
                                                        </span>
                                                        <div
                                                          className="topic_selection hidden"
                                                          id="__w2_wS3v0b3P63_topic"
                                                        />
                                                        <input
                                                          className="hidden"
                                                          type="number"
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P63"
                                                          id="__w2_wS3v0b3P63_value"
                                                        />
                                                        <div
                                                          className="remove_link hidden"
                                                          id="__w2_wS3v0b3P63_remove_topic"
                                                        >
                                                          <span
                                                            className="ui_icon ui_icon_color--gray ui_icon_size--xsmall ui_icon_outline--default"
                                                            aria-hidden="true"
                                                      ...
                                                      <div className="FormField FormFieldInput with_label with_character_counter">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P64_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <label
                                                          className="input_label"
                                                          htmlFor="__w2_wS3v0b3P64_experience"
                                                        ...
                                                        <input
                                                          ...
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P64"
                                                          id="__w2_wS3v0b3P64_experience"
                                                        />
                                                        <div
                                                          className="CharacterCounter fade_out"
                                                          id="__w2_wS3v0b3P70_counter_wrapper"
                                                        >
                                                          <div
                                                            className="counter"
                                                            id="__w2_wS3v0b3P70_counter"
                                                          >
                                                            60
                                                          </div>
                                                        </div>
                                                      ...
                                                      <div
                                                        className="LifeExperienceExamples"
                                                        id="__w2_wS3v0b3P65_wrapper"
                                                      >
                                                        More examples:{" "}
                                                        <span
                                                          id="__w2_wS3v0b3P65_example"
                                              ...
                                              >
                                                <div className="edit_wrapper">
                                                  ...
                                                  <div id="wS3v0b3P30">
                                                    <form
                                                      className="AddCredentialsFormLanguage Form AddCredentialsForm"
                                                      method="post"
                                                      id="__w2_wS3v0b3P31_form"
                                                    >
                                                      <div className="FormField FormFieldTopicSelector FormFieldLanguageSelector">
                                                        <div
                                                          className="error_tooltip hidden"
                                                          id="__w2_wS3v0b3P71_error_tooltip"
                                                        >
                                                          Please fill out this
                                                          field.
                                                        </div>
                                                        <span id="__w2_wS3v0b3P71_selector">
                                                          <div
                                                            className="Selector LanguageSelector TopicSelectorForFormField"
                                                            tabIndex={-1}
                                                            id="__w2_wS3v0b3P72_wrapper"
                                                          >
                                                            <div className="selector_input_interaction">
                                                              <input
                                                                className="selector_input text"
                                                                ...
                                                                w2cid="wS3v0b3P72"
                                                                id="__w2_wS3v0b3P72_input"
                                                              />
                                                              <div
                                                                className="selector_spinner hidden"
                                                                id="__w2_wS3v0b3P72_spinner"
                                                              >
                                                                <div className="LoadingDots tiny">
                                                                  <div className="dot first" />
                                                                  <div className="dot second" />
                                                            ...
                                                            <div
                                                              className="selector_results_container is_inline hidden"
                                                              id="__w2_wS3v0b3P72_results_container"
                                                            >
                                                              <div
                                                                className="selector_results_container_inner hidden"
                                                                id="__w2_wS3v0b3P72_results"
                                                              />
                                                              <div id="__w2_wS3v0b3P72_empty_input_prompt" />
                                                            </div>
                                                          </div>
                                                        </span>
                                                        <div
                                                          className="topic_selection hidden"
                                                          id="__w2_wS3v0b3P71_language_tid"
                                                        />
                                                        <input
                                                          className="hidden"
                                                          type="number"
                                                          data-group="js-editable"
                                                          w2cid="wS3v0b3P71"
                                                          id="__w2_wS3v0b3P71_value"
                                                        />
                                                        <div
                                                          className="remove_link hidden"
                                                          id="__w2_wS3v0b3P71_remove_topic"
                                                        >
                                                          <span
                                                            className="ui_icon ui_icon_color--gray ui_icon_size--xsmall ui_icon_outline--default"
                                                            aria-hidden="true"
                                                      ...
                                                      <div className="join_explanation">
                                                        Adding a language
                                                        credential will add you
                                                        to Quora in that
                                                        language, when
                                                        supported.{" "}
                                                      </div>
                                          ...
                                          <div
                                            className="list_wrapper hidden"
                                            id="__w2_wS3v0b3P3_wrapper"
                                          >
                                            <div
                                              className="PagedListFoo CredentialsList EditCredentialsList unified"
                                              id="__w2_wS3v0b3P6_paged_list"
                                            >
                                              <div
                                                className="paged_list_wrapper"
                                                id="__w2_wS3v0b3P6_paged_list_wrapper"
                                              >
                                                <div
                                                  className="u-height--100 u-width--100"
                                                  id="wS3v0b3P84"
                                                >
                                                  <div className="ui_empty--wrapper-stretch u-bg--gray">
                                                    <div className="ui_empty u-text-align--center u-text--gray u-padding-all--lg ui_empty--fit-stretch">
                                                      <img
                                                        className="ui_empty--svg-illustration u-margin-top--lg u-margin-bottom--sm"
                                                        src="/static/images/ui/illustrations/empty_states/dormant.png"
                                                      />
                                                      <div className="u-sans-font-main--large u-font-weight--bold u-margin-bottom--sm">
                                                        No Credentials
                                                      </div>
                                                      <div className="u-sans-font-main--regular u-margin-bottom--lg">
                                                        Add credentials to let
                                                        others know what topics
                                                        you know about.
                                                      </div>
                                                    </div>
                                                  </div>
...
: null }
      ...
      <div className="modal_footer" id="__w2_wl8oHrDR2_modal_footer">
         <div className="modal_actions" id="__w2_wl8oHrDR2_modal_actions"><span className="text_links" /><a className="submit_button modal_action" href="#" id="__w2_wl8oHrDR2_submit">Done</a></div>
                  ...
                  <div id="wYSVVNEt47">
                    <div
                      className="ProfileExperienceList EditableList"
                      id="__w2_wYSVVNEt48_wrapper"
                    >
                      <h3 className="title">
                        <div>
